...
;------------------------------------------------------------
;	src/main.c:88: void Serial_ISR(void) __interrupt(4)
;	-----------------------------------------
;	 function Serial_ISR
;	-----------------------------------------
_Serial_ISR:
...
;	src/main.c:90: if(RI){
	jnb	_RI,00103$
;	src/main.c:91: *wr_pointer = SBUF;
	mov	dptr,#_wr_pointer
	movx	a,@dptr
	mov	r1,a
	mov	@r1,_SBUF
;	src/main.c:92: is_recieved = 1;
;	assignBit
	setb	_is_recieved
;	src/main.c:93: wr_pointer++;
	mov	dptr,#_wr_pointer
	mov	a,r1
	inc	a
	movx	@dptr,a
...
;------------------------------------------------------------
;	src/main.c:99: void Timer2_ISR(void) __interrupt(5)
;	-----------------------------------------
;	 function Timer2_ISR
;	-----------------------------------------
_Timer2_ISR:
	push	acc
;	src/main.c:101: system_tick++;
	mov	a,_system_tick
	inc	a
	mov	_system_tick,a
;	src/main.c:102: }
...
;	-----------------------------------------
_main:
;	src/main.c:106: SP = hw_stack; 		//initiaslze Stack Pointer;
	mov	_SP,#0x60
;	src/main.c:107: init_sys();
	lcall	_init_sys
;	src/main.c:108: init_serial();
	lcall	_init_serial
;	src/main.c:112: print_boot_message();
