      ...
      00001C                        411 	.ds	7
      000023 02 01 58         [24]  412 	ljmp	_Serial_ISR
      000026                        413 	.ds	5
      00002B 02 01 84         [24]  414 	ljmp	_Timer2_ISR
      ...
      000071 02 01 8E         [24]  529 	ljmp	_main
      ...
      000142 B5 30 01         [24]  685 	cjne	a,_loop_counter,00118$
      000145 22               [24]  686 	ret
      000146                        687 00118$:
                                    688 ;	src/main.c:81: uart_send(boot_message[loop_counter]);
      000146 E5 30            [12]  689 	mov	a,_loop_counter
      000148 90 01 A0         [24]  690 	mov	dptr,#_boot_message
      00014B 93               [24]  691 	movc	a,@a+dptr
      00014C F5 82            [12]  692 	mov	dpl,a
      00014E 12 01 30         [24]  693 	lcall	_uart_send
                                    694 ;	src/main.c:82: loop_counter++;
      000151 E5 30            [12]  695 	mov	a,_loop_counter
      000153 04               [12]  696 	inc	a
      000154 F5 30            [12]  697 	mov	_loop_counter,a
                                    698 ;	src/main.c:84: }
      000156 80 E8            [24]  699 	sjmp	00101$
                                    700 ;------------------------------------------------------------
                                    701 ;Allocation info for local variables in function 'Serial_ISR'
                                    702 ;------------------------------------------------------------
                                    703 ;	src/main.c:88: void Serial_ISR(void) __interrupt(4)
                                    704 ;	-----------------------------------------
                                    705 ;	 function Serial_ISR
                                    706 ;	-----------------------------------------
      000158                        707 _Serial_ISR:
      000158 C0 E0            [24]  708 	push	acc
      00015A C0 82            [24]  709 	push	dpl
      00015C C0 83            [24]  710 	push	dph
      00015E C0 01            [24]  711 	push	ar1
      000160 C0 D0            [24]  712 	push	psw
      000162 75 D0 00         [24]  713 	mov	psw,#0x00
                                    714 ;	src/main.c:90: if(RI){
      000165 30 98 11         [24]  715 	jnb	_RI,00103$
                                    716 ;	src/main.c:91: *wr_pointer = SBUF;
      000168 90 00 33         [24]  717 	mov	dptr,#_wr_pointer
      00016B E0               [24]  718 	movx	a,@dptr
      00016C F9               [12]  719 	mov	r1,a
      00016D A7 99            [24]  720 	mov	@r1,_SBUF
                                    721 ;	src/main.c:92: is_recieved = 1;
                                    722 ;	assignBit
      00016F D2 00            [12]  723 	setb	_is_recieved
                                    724 ;	src/main.c:93: wr_pointer++;
      000171 90 00 33         [24]  725 	mov	dptr,#_wr_pointer
      000174 E9               [12]  726 	mov	a,r1
      000175 04               [12]  727 	inc	a
      000176 F0               [24]  728 	movx	@dptr,a
                                    729 ;	src/main.c:94: RI = 0;
                                    730 ;	assignBit
      000177 C2 98            [12]  731 	clr	_RI
      000179                        732 00103$:
                                    733 ;	src/main.c:96: }
      000179 D0 D0            [24]  734 	pop	psw
      00017B D0 01            [24]  735 	pop	ar1
      00017D D0 83            [24]  736 	pop	dph
      00017F D0 82            [24]  737 	pop	dpl
      000181 D0 E0            [24]  738 	pop	acc
      000183 32               [24]  739 	reti
                                    740 ;	eliminated unneeded push/pop ar0
                                    741 ;	eliminated unneeded push/pop b
                                    742 ;------------------------------------------------------------
                                    743 ;Allocation info for local variables in function 'Timer2_ISR'
                                    744 ;------------------------------------------------------------
                                    745 ;	src/main.c:99: void Timer2_ISR(void) __interrupt(5)
                                    746 ;	-----------------------------------------
                                    747 ;	 function Timer2_ISR
                                    748 ;	-----------------------------------------
      000184                        749 _Timer2_ISR:
      000184 C0 E0            [24]  750 	push	acc
                                    751 ;	src/main.c:101: system_tick++;
      000186 E5 34            [12]  752 	mov	a,_system_tick
      000188 04               [12]  753 	inc	a
      000189 F5 34            [12]  754 	mov	_system_tick,a
                                    755 ;	src/main.c:102: }
      00018B D0 E0            [24]  756 	pop	acc
      00018D 32               [24]  757 	reti
                                    758 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    759 ;	eliminated unneeded push/pop not_psw
                                    760 ;	eliminated unneeded push/pop dpl
                                    761 ;	eliminated unneeded push/pop dph
                                    762 ;	eliminated unneeded push/pop b
                                    763 ;------------------------------------------------------------
                                    764 ;Allocation info for local variables in function 'main'
                                    765 ;------------------------------------------------------------
                                    766 ;	src/main.c:105: void main(void){
                                    767 ;	-----------------------------------------
                                    768 ;	 function main
                                    769 ;	-----------------------------------------
      00018E                        770 _main:
                                    771 ;	src/main.c:106: SP = hw_stack; 		//initiaslze Stack Pointer;
      00018E 75 81 60         [24]  772 	mov	_SP,#0x60
                                    773 ;	src/main.c:107: init_sys();
      000191 12 01 04         [24]  774 	lcall	_init_sys
                                    775 ;	src/main.c:108: init_serial();
      000194 12 01 1F         [24]  776 	lcall	_init_serial
                                    777 ;	src/main.c:112: print_boot_message();
      000197 12 01 3D         [24]  778 	lcall	_print_boot_message
                                    779 ;	src/main.c:114: while(1);
      00019A                        780 00102$:
                                    781 ;	src/main.c:115: }
      00019A 80 FE            [24]  782 	sjmp	00102$
                                    783 	.area CSEG    (CODE)
                                    784 	.area CONST   (CODE)
                                    785 	.area CONST   (CODE)
      0001A0                        786 _boot_message:
      0001A0 4D                     787 	.db #0x4d	; 77	'M'
      0001A1 69                     788 	.db #0x69	; 105	'i'
      0001A2 72                     789 	.db #0x72	; 114	'r'
      0001A3 6F                     790 	.db #0x6f	; 111	'o'
      0001A4 20                     791 	.db #0x20	; 32
      0001A5 56                     792 	.db #0x56	; 86	'V'
      0001A6 69                     793 	.db #0x69	; 105	'i'
      0001A7 72                     794 	.db #0x72	; 114	'r'
      0001A8 74                     795 	.db #0x74	; 116	't'
      0001A9 75                     796 	.db #0x75	; 117	'u'
      0001AA 61                     797 	.db #0x61	; 97	'a'
      0001AB 6C                     798 	.db #0x6c	; 108	'l'
      0001AC 2D                     799 	.db #0x2d	; 45
      0001AD 52                     800 	.db #0x52	; 82	'R'
      0001AE 20                     801 	.db #0x20	; 32
      0001AF 43                     802 	.db #0x43	; 67	'C'
      0001B0 6F                     803 	.db #0x6f	; 111	'o'
      0001B1 70                     804 	.db #0x70	; 112	'p'
      0001B2 79                     805 	.db #0x79	; 121	'y'
      0001B3 72                     806 	.db #0x72	; 114	'r'
      0001B4 69                     807 	.db #0x69	; 105	'i'
      0001B5 67                     808 	.db #0x67	; 103	'g'
      0001B6 68                     809 	.db #0x68	; 104	'h'
      0001B7 74                     810 	.db #0x74	; 116	't'
      0001B8 20                     811 	.db #0x20	; 32
      0001B9 32                     812 	.db #0x32	; 50	'2'
      0001BA 30                     813 	.db #0x30	; 48	'0'
      0001BB 32                     814 	.db #0x32	; 50	'2'
      0001BC 36                     815 	.db #0x36	; 54	'6'
      0001BD 0D                     816 	.db #0x0d	; 13
      0001BE 0A                     817 	.db #0x0a	; 10
      0001BF 42                     818 	.db #0x42	; 66	'B'
      0001C0 61                     819 	.db #0x61	; 97	'a'
      0001C1 69                     820 	.db #0x69	; 105	'i'
      0001C2 62                     821 	.db #0x62	; 98	'b'
      0001C3 68                     822 	.db #0x68	; 104	'h'
      0001C4 61                     823 	.db #0x61	; 97	'a'
      0001C5 76                     824 	.db #0x76	; 118	'v'
      0001C6 20                     825 	.db #0x20	; 32
      0001C7 42                     826 	.db #0x42	; 66	'B'
      0001C8 68                     827 	.db #0x68	; 104	'h'
      0001C9 61                     828 	.db #0x61	; 97	'a'
      0001CA 74                     829 	.db #0x74	; 116	't'
      0001CB 74                     830 	.db #0x74	; 116	't'
      0001CC 61                     831 	.db #0x61	; 97	'a'
      0001CD 63                     832 	.db #0x63	; 99	'c'
      0001CE 68                     833 	.db #0x68	; 104	'h'
      0001CF 72                     834 	.db #0x72	; 114	'r'
      0001D0 79                     835 	.db #0x79	; 121	'y'
      0001D1 61                     836 	.db #0x61	; 97	'a'
      0001D2 0D                     837 	.db #0x0d	; 13
      0001D3 0A                     838 	.db #0x0a	; 10
      0001D4 00                     839 	.db 0x00
      0001D5 00                     840 	.db 0x00
      0001D6 00                     841 	.db 0x00
                                    842 	.area CSEG    (CODE)
                                    843 	.area CONST   (CODE)
      0001D7                        844 _ready_msg:
      0001D7 52                     845 	.db #0x52	; 82	'R'
      0001D8 45                     846 	.db #0x45	; 69	'E'
      0001D9 41                     847 	.db #0x41	; 65	'A'
      0001DA 44                     848 	.db #0x44	; 68	'D'
      0001DB 59                     849 	.db #0x59	; 89	'Y'
      0001DC 0D                     850 	.db #0x0d	; 13
      0001DD 0A                     851 	.db #0x0a	; 10
                                    852 	.area CSEG    (CODE)
                                    853 	.area XINIT   (CODE)
