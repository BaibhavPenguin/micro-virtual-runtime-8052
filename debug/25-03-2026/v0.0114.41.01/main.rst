      ...
      000117 AF 82            [24]  572 	mov	r7, dpl
                                    573 ;	src/main.c:52: while(serial_busy != 0x00);
      000119                        574 00101$:
      000119 E5 38            [12]  575 	mov	a,_serial_busy
      00011B 70 FC            [24]  576 	jnz	00101$
                                    577 ;	src/main.c:53: serial_busy = 0x01;
      00011D 75 38 01         [24]  578 	mov	_serial_busy,#0x01
                                    579 ;	src/main.c:54: SBUF = args;
      000120 8F 99            [24]  580 	mov	_SBUF,r7
                                    581 ;	src/main.c:57: }
      000122 22               [24]  582 	ret
                                    583 ;------------------------------------------------------------
      ...
      000123 75 38 01         [24]  592 	mov	_serial_busy,#0x01
                                    593 ;	src/main.c:61: while(rd_pointer == wr_pointer);
      000126                        594 00101$:
      000126 E5 33            [12]  595 	mov	a,_wr_pointer
      000128 B5 32 02         [24]  596 	cjne	a,_rd_pointer,00133$
      00012B 80 F9            [24]  597 	sjmp	00101$
      00012D                        598 00133$:
                                    599 ;	src/main.c:62: SBUF = *rd_pointer;
      00012D A9 32            [24]  600 	mov	r1,_rd_pointer
      00012F 87 99            [24]  601 	mov	_SBUF,@r1
                                    602 ;	src/main.c:63: while(serial_busy);
      000131                        603 00104$:
      000131 E5 38            [12]  604 	mov	a,_serial_busy
      000133 70 FC            [24]  605 	jnz	00104$
                                    606 ;	src/main.c:64: rd_pointer++;
      000135 05 32            [12]  607 	inc	_rd_pointer
                                    608 ;	src/main.c:66: }
      000137 22               [24]  609 	ret
                                    610 ;------------------------------------------------------------
                                    ...
                                    616 ;	-----------------------------------------
      000138                        617 _delay_ms_500:
                                    618 ;	src/main.c:75: }
      000138 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    ...
                                    626 ;	-----------------------------------------
      000139                        627 _ascii_to_hex:
                                    628 ;	src/main.c:83: }
      000139 22               [24]  629 	ret
                                    630 ;------------------------------------------------------------
                                    ...
                                    636 ;	-----------------------------------------
      00013A                        637 _hex_to_ascii:
                                    638 ;	src/main.c:92: }
      00013A 22               [24]  639 	ret
                                    640 ;------------------------------------------------------------
                                    ...
                                    646 ;	-----------------------------------------
      00013B                        647 _print_boot_message:
                                    648 ;	src/main.c:99: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      00013B 75 82 44         [24]  649 	mov	dpl, #0x44
      00013E 12 01 17         [24]  650 	lcall	_put_char
      000141 75 82 65         [24]  651 	mov	dpl, #0x65
      000144 12 01 17         [24]  652 	lcall	_put_char
      000147 75 82 62         [24]  653 	mov	dpl, #0x62
      00014A 12 01 17         [24]  654 	lcall	_put_char
      00014D 75 82 75         [24]  655 	mov	dpl, #0x75
      000150 12 01 17         [24]  656 	lcall	_put_char
      000153 75 82 67         [24]  657 	mov	dpl, #0x67
      000156 12 01 17         [24]  658 	lcall	_put_char
      000159 75 82 0A         [24]  659 	mov	dpl, #0x0a
                                    660 ;	src/main.c:101: }
      00015C 02 01 17         [24]  661 	ljmp	_put_char
                                    662 ;------------------------------------------------------------
                                    ...
                                    668 ;	-----------------------------------------
      00015F                        669 _Serial_ISR:
      00015F C0 E0            [24]  670 	push	acc
      000161 C0 00            [24]  671 	push	ar0
      000163 C0 D0            [24]  672 	push	psw
      000165 75 D0 00         [24]  673 	mov	psw,#0x00
                                    674 ;	src/main.c:111: if(RI){						//Recieve Interrput == RI
      000168 30 98 09         [24]  675 	jnb	_RI,00102$
                                    676 ;	src/main.c:112: *wr_pointer = SBUF;		//Store Input Data in Buffer
      00016B E5 33            [12]  677 	mov	a,_wr_pointer
      00016D F8               [12]  678 	mov	r0,a
      00016E A6 99            [24]  679 	mov	@r0,_SBUF
                                    680 ;	src/main.c:113: wr_pointer++;
      000170 05 33            [12]  681 	inc	_wr_pointer
                                    682 ;	src/main.c:114: RI = 0;
                                    683 ;	assignBit
      000172 C2 98            [12]  684 	clr	_RI
      000174                        685 00102$:
                                    686 ;	src/main.c:117: if(TI){
                                    687 ;	src/main.c:118: TI = 0;
                                    688 ;	assignBit
      000174 10 99 02         [24]  689 	jbc	_TI,00120$
      000177 80 03            [24]  690 	sjmp	00105$
      000179                        691 00120$:
                                    692 ;	src/main.c:119: serial_busy = 0;
      000179 75 38 00         [24]  693 	mov	_serial_busy,#0x00
      00017C                        694 00105$:
                                    695 ;	src/main.c:121: }
      00017C D0 D0            [24]  696 	pop	psw
      00017E D0 00            [24]  697 	pop	ar0
      000180 D0 E0            [24]  698 	pop	acc
      000182 32               [24]  699 	reti
                                    700 ;	eliminated unneeded push/pop ar1
                                    701 ;	eliminated unneeded push/pop dpl
                                    702 ;	eliminated unneeded push/pop dph
                                    703 ;	eliminated unneeded push/pop b
                                    704 ;------------------------------------------------------------
                                    705 ;Allocation info for local variables in function 'main'
                                    706 ;------------------------------------------------------------
                                    707 ;	src/main.c:123: void main(void){
                                    708 ;	-----------------------------------------
                                    709 ;	 function main
                                    710 ;	-----------------------------------------
      000183                        711 _main:
                                    712 ;	src/main.c:124: init_mpu();
      000183 12 00 CB         [24]  713 	lcall	_init_mpu
                                    714 ;	src/main.c:126: init_serial();
      000186 12 00 FF         [24]  715 	lcall	_init_serial
                                    716 ;	src/main.c:128: serial_busy = 0;
      000189 75 38 00         [24]  717 	mov	_serial_busy,#0x00
                                    718 ;	src/main.c:130: while(1){
      00018C                        719 00102$:
                                    720 ;	src/main.c:131: put_char('A');
      00018C 75 82 41         [24]  721 	mov	dpl, #0x41
      00018F 12 01 17         [24]  722 	lcall	_put_char
                                    723 ;	src/main.c:133: }
      000192 80 F8            [24]  724 	sjmp	00102$
                                    725 	.area CSEG    (CODE)
                                    726 	.area CONST   (CODE)
                                    727 	.area XINIT   (CODE)
