      ...
      00001C                        378 	.ds	7
      000023 02 01 60         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 84         [24]  461 	ljmp	_main
      ...
      000117 AF 82            [24]  572 	mov	r7, dpl
                                    573 ;	src/main.c:52: do{
      000119                        574 00101$:
                                    575 ;	src/main.c:53: __asm__("nop");
      000119 00               [12]  576 	nop
                                    577 ;	src/main.c:54: }while(serial_busy != 0x00);
      00011A E5 38            [12]  578 	mov	a,_serial_busy
      00011C 70 FB            [24]  579 	jnz	00101$
                                    580 ;	src/main.c:56: serial_busy = 0x01;
      00011E 75 38 01         [24]  581 	mov	_serial_busy,#0x01
                                    582 ;	src/main.c:57: SBUF = args;
      000121 8F 99            [24]  583 	mov	_SBUF,r7
                                    584 ;	src/main.c:60: }
      000123 22               [24]  585 	ret
                                    586 ;------------------------------------------------------------
                                    587 ;Allocation info for local variables in function 'echo'
                                    588 ;------------------------------------------------------------
                                    589 ;	src/main.c:62: void echo(void){
                                    590 ;	-----------------------------------------
                                    591 ;	 function echo
                                    592 ;	-----------------------------------------
      000124                        593 _echo:
                                    594 ;	src/main.c:63: serial_busy = 1;
      000124 75 38 01         [24]  595 	mov	_serial_busy,#0x01
                                    596 ;	src/main.c:64: while(rd_pointer == wr_pointer);
      000127                        597 00101$:
      000127 E5 33            [12]  598 	mov	a,_wr_pointer
      000129 B5 32 02         [24]  599 	cjne	a,_rd_pointer,00133$
      00012C 80 F9            [24]  600 	sjmp	00101$
      00012E                        601 00133$:
                                    602 ;	src/main.c:65: SBUF = *rd_pointer;
      00012E A9 32            [24]  603 	mov	r1,_rd_pointer
      000130 87 99            [24]  604 	mov	_SBUF,@r1
                                    605 ;	src/main.c:66: while(serial_busy);
      000132                        606 00104$:
      000132 E5 38            [12]  607 	mov	a,_serial_busy
      000134 70 FC            [24]  608 	jnz	00104$
                                    609 ;	src/main.c:67: rd_pointer++;
      000136 05 32            [12]  610 	inc	_rd_pointer
                                    611 ;	src/main.c:69: }
      000138 22               [24]  612 	ret
                                    613 ;------------------------------------------------------------
                                    614 ;Allocation info for local variables in function 'delay_ms_500'
                                    615 ;------------------------------------------------------------
                                    616 ;	src/main.c:75: void delay_ms_500(void){
                                    617 ;	-----------------------------------------
                                    618 ;	 function delay_ms_500
                                    619 ;	-----------------------------------------
      000139                        620 _delay_ms_500:
                                    621 ;	src/main.c:78: }
      000139 22               [24]  622 	ret
                                    623 ;------------------------------------------------------------
                                    624 ;Allocation info for local variables in function 'ascii_to_hex'
                                    625 ;------------------------------------------------------------
                                    626 ;	src/main.c:83: void ascii_to_hex(void){
                                    627 ;	-----------------------------------------
                                    628 ;	 function ascii_to_hex
                                    629 ;	-----------------------------------------
      00013A                        630 _ascii_to_hex:
                                    631 ;	src/main.c:86: }
      00013A 22               [24]  632 	ret
                                    633 ;------------------------------------------------------------
                                    634 ;Allocation info for local variables in function 'hex_to_ascii'
                                    635 ;------------------------------------------------------------
                                    636 ;	src/main.c:92: void hex_to_ascii(void){
                                    637 ;	-----------------------------------------
                                    638 ;	 function hex_to_ascii
                                    639 ;	-----------------------------------------
      00013B                        640 _hex_to_ascii:
                                    641 ;	src/main.c:95: }
      00013B 22               [24]  642 	ret
                                    643 ;------------------------------------------------------------
                                    644 ;Allocation info for local variables in function 'print_boot_message'
                                    645 ;------------------------------------------------------------
                                    646 ;	src/main.c:100: void print_boot_message(void){
                                    647 ;	-----------------------------------------
                                    648 ;	 function print_boot_message
                                    649 ;	-----------------------------------------
      00013C                        650 _print_boot_message:
                                    651 ;	src/main.c:102: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      00013C 75 82 44         [24]  652 	mov	dpl, #0x44
      00013F 12 01 17         [24]  653 	lcall	_put_char
      000142 75 82 65         [24]  654 	mov	dpl, #0x65
      000145 12 01 17         [24]  655 	lcall	_put_char
      000148 75 82 62         [24]  656 	mov	dpl, #0x62
      00014B 12 01 17         [24]  657 	lcall	_put_char
      00014E 75 82 75         [24]  658 	mov	dpl, #0x75
      000151 12 01 17         [24]  659 	lcall	_put_char
      000154 75 82 67         [24]  660 	mov	dpl, #0x67
      000157 12 01 17         [24]  661 	lcall	_put_char
      00015A 75 82 0A         [24]  662 	mov	dpl, #0x0a
                                    663 ;	src/main.c:104: }
      00015D 02 01 17         [24]  664 	ljmp	_put_char
                                    665 ;------------------------------------------------------------
                                    666 ;Allocation info for local variables in function 'Serial_ISR'
                                    667 ;------------------------------------------------------------
                                    668 ;	src/main.c:112: void Serial_ISR(void) __interrupt (4)
                                    669 ;	-----------------------------------------
                                    670 ;	 function Serial_ISR
                                    671 ;	-----------------------------------------
      000160                        672 _Serial_ISR:
      000160 C0 E0            [24]  673 	push	acc
      000162 C0 00            [24]  674 	push	ar0
      000164 C0 D0            [24]  675 	push	psw
      000166 75 D0 00         [24]  676 	mov	psw,#0x00
                                    677 ;	src/main.c:114: if(RI){						//Recieve Interrput == RI
      000169 30 98 09         [24]  678 	jnb	_RI,00102$
                                    679 ;	src/main.c:115: *wr_pointer = SBUF;		//Store Input Data in Buffer
      00016C E5 33            [12]  680 	mov	a,_wr_pointer
      00016E F8               [12]  681 	mov	r0,a
      00016F A6 99            [24]  682 	mov	@r0,_SBUF
                                    683 ;	src/main.c:116: wr_pointer++;
      000171 05 33            [12]  684 	inc	_wr_pointer
                                    685 ;	src/main.c:117: RI = 0;
                                    686 ;	assignBit
      000173 C2 98            [12]  687 	clr	_RI
      000175                        688 00102$:
                                    689 ;	src/main.c:120: if(TI){
                                    690 ;	src/main.c:121: TI = 0;
                                    691 ;	assignBit
      000175 10 99 02         [24]  692 	jbc	_TI,00120$
      000178 80 03            [24]  693 	sjmp	00105$
      00017A                        694 00120$:
                                    695 ;	src/main.c:122: serial_busy = 0;
      00017A 75 38 00         [24]  696 	mov	_serial_busy,#0x00
      00017D                        697 00105$:
                                    698 ;	src/main.c:124: }
      00017D D0 D0            [24]  699 	pop	psw
      00017F D0 00            [24]  700 	pop	ar0
      000181 D0 E0            [24]  701 	pop	acc
      000183 32               [24]  702 	reti
                                    703 ;	eliminated unneeded push/pop ar1
                                    704 ;	eliminated unneeded push/pop dpl
                                    705 ;	eliminated unneeded push/pop dph
                                    706 ;	eliminated unneeded push/pop b
                                    707 ;------------------------------------------------------------
                                    708 ;Allocation info for local variables in function 'main'
                                    709 ;------------------------------------------------------------
                                    710 ;	src/main.c:126: void main(void){
                                    711 ;	-----------------------------------------
                                    712 ;	 function main
                                    713 ;	-----------------------------------------
      000184                        714 _main:
                                    715 ;	src/main.c:127: init_mpu();
      000184 12 00 CB         [24]  716 	lcall	_init_mpu
                                    717 ;	src/main.c:129: init_serial();
      000187 12 00 FF         [24]  718 	lcall	_init_serial
                                    719 ;	src/main.c:131: serial_busy = 0;
      00018A 75 38 00         [24]  720 	mov	_serial_busy,#0x00
                                    721 ;	src/main.c:133: while(1){
      00018D                        722 00102$:
                                    723 ;	src/main.c:134: put_char('A');
      00018D 75 82 41         [24]  724 	mov	dpl, #0x41
      000190 12 01 17         [24]  725 	lcall	_put_char
                                    726 ;	src/main.c:136: }
      000193 80 F8            [24]  727 	sjmp	00102$
                                    728 	.area CSEG    (CODE)
                                    729 	.area CONST   (CODE)
                                    730 	.area XINIT   (CODE)
