      ...
      00001C                        378 	.ds	7
      000023 02 01 55         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 79         [24]  461 	ljmp	_main
      ...
      000112 85 82 99         [24]  568 	mov	_SBUF,dpl
                                    569 ;	src/main.c:52: while(!TI);
      000115                        570 00101$:
      000115 30 99 FD         [24]  571 	jnb	_TI,00101$
                                    572 ;	src/main.c:54: }
      000118 22               [24]  573 	ret
                                    574 ;------------------------------------------------------------
                                    575 ;Allocation info for local variables in function 'echo'
                                    576 ;------------------------------------------------------------
                                    577 ;	src/main.c:56: void echo(void){
                                    578 ;	-----------------------------------------
                                    579 ;	 function echo
                                    580 ;	-----------------------------------------
      000119                        581 _echo:
                                    582 ;	src/main.c:57: serial_busy = 1;
      000119 75 38 01         [24]  583 	mov	_serial_busy,#0x01
                                    584 ;	src/main.c:58: while(rd_pointer == wr_pointer);
      00011C                        585 00101$:
      00011C E5 33            [12]  586 	mov	a,_wr_pointer
      00011E B5 32 02         [24]  587 	cjne	a,_rd_pointer,00133$
      000121 80 F9            [24]  588 	sjmp	00101$
      000123                        589 00133$:
                                    590 ;	src/main.c:59: SBUF = *rd_pointer;
      000123 A9 32            [24]  591 	mov	r1,_rd_pointer
      000125 87 99            [24]  592 	mov	_SBUF,@r1
                                    593 ;	src/main.c:60: while(serial_busy);
      000127                        594 00104$:
      000127 E5 38            [12]  595 	mov	a,_serial_busy
      000129 70 FC            [24]  596 	jnz	00104$
                                    597 ;	src/main.c:61: rd_pointer++;
      00012B 05 32            [12]  598 	inc	_rd_pointer
                                    599 ;	src/main.c:63: }
      00012D 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    602 ;Allocation info for local variables in function 'delay_ms_500'
                                    603 ;------------------------------------------------------------
                                    604 ;	src/main.c:69: void delay_ms_500(void){
                                    605 ;	-----------------------------------------
                                    606 ;	 function delay_ms_500
                                    607 ;	-----------------------------------------
      00012E                        608 _delay_ms_500:
                                    609 ;	src/main.c:72: }
      00012E 22               [24]  610 	ret
                                    611 ;------------------------------------------------------------
                                    612 ;Allocation info for local variables in function 'ascii_to_hex'
                                    613 ;------------------------------------------------------------
                                    614 ;	src/main.c:77: void ascii_to_hex(void){
                                    615 ;	-----------------------------------------
                                    616 ;	 function ascii_to_hex
                                    617 ;	-----------------------------------------
      00012F                        618 _ascii_to_hex:
                                    619 ;	src/main.c:80: }
      00012F 22               [24]  620 	ret
                                    621 ;------------------------------------------------------------
                                    622 ;Allocation info for local variables in function 'hex_to_ascii'
                                    623 ;------------------------------------------------------------
                                    624 ;	src/main.c:86: void hex_to_ascii(void){
                                    625 ;	-----------------------------------------
                                    626 ;	 function hex_to_ascii
                                    627 ;	-----------------------------------------
      000130                        628 _hex_to_ascii:
                                    629 ;	src/main.c:89: }
      000130 22               [24]  630 	ret
                                    631 ;------------------------------------------------------------
                                    632 ;Allocation info for local variables in function 'print_boot_message'
                                    633 ;------------------------------------------------------------
                                    634 ;	src/main.c:94: void print_boot_message(void){
                                    635 ;	-----------------------------------------
                                    636 ;	 function print_boot_message
                                    637 ;	-----------------------------------------
      000131                        638 _print_boot_message:
                                    639 ;	src/main.c:96: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000131 75 82 44         [24]  640 	mov	dpl, #0x44
      000134 12 01 12         [24]  641 	lcall	_put_char
      000137 75 82 65         [24]  642 	mov	dpl, #0x65
      00013A 12 01 12         [24]  643 	lcall	_put_char
      00013D 75 82 62         [24]  644 	mov	dpl, #0x62
      000140 12 01 12         [24]  645 	lcall	_put_char
      000143 75 82 75         [24]  646 	mov	dpl, #0x75
      000146 12 01 12         [24]  647 	lcall	_put_char
      000149 75 82 67         [24]  648 	mov	dpl, #0x67
      00014C 12 01 12         [24]  649 	lcall	_put_char
      00014F 75 82 0A         [24]  650 	mov	dpl, #0x0a
                                    651 ;	src/main.c:98: }
      000152 02 01 12         [24]  652 	ljmp	_put_char
                                    653 ;------------------------------------------------------------
                                    654 ;Allocation info for local variables in function 'Serial_ISR'
                                    655 ;------------------------------------------------------------
                                    656 ;	src/main.c:106: void Serial_ISR(void) __interrupt (4)
                                    657 ;	-----------------------------------------
                                    658 ;	 function Serial_ISR
                                    659 ;	-----------------------------------------
      000155                        660 _Serial_ISR:
      000155 C0 E0            [24]  661 	push	acc
      000157 C0 00            [24]  662 	push	ar0
      000159 C0 D0            [24]  663 	push	psw
      00015B 75 D0 00         [24]  664 	mov	psw,#0x00
                                    665 ;	src/main.c:108: if(RI){						//Recieve Interrput == RI
      00015E 30 98 09         [24]  666 	jnb	_RI,00102$
                                    667 ;	src/main.c:109: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000161 E5 33            [12]  668 	mov	a,_wr_pointer
      000163 F8               [12]  669 	mov	r0,a
      000164 A6 99            [24]  670 	mov	@r0,_SBUF
                                    671 ;	src/main.c:110: wr_pointer++;
      000166 05 33            [12]  672 	inc	_wr_pointer
                                    673 ;	src/main.c:111: RI = 0;
                                    674 ;	assignBit
      000168 C2 98            [12]  675 	clr	_RI
      00016A                        676 00102$:
                                    677 ;	src/main.c:114: if(TI){
                                    678 ;	src/main.c:115: TI = 0;
                                    679 ;	assignBit
      00016A 10 99 02         [24]  680 	jbc	_TI,00120$
      00016D 80 03            [24]  681 	sjmp	00105$
      00016F                        682 00120$:
                                    683 ;	src/main.c:116: serial_busy = 0;		//serial_busy flag;
      00016F 75 38 00         [24]  684 	mov	_serial_busy,#0x00
      000172                        685 00105$:
                                    686 ;	src/main.c:120: }
      000172 D0 D0            [24]  687 	pop	psw
      000174 D0 00            [24]  688 	pop	ar0
      000176 D0 E0            [24]  689 	pop	acc
      000178 32               [24]  690 	reti
                                    691 ;	eliminated unneeded push/pop ar1
                                    ...
                                    697 ;------------------------------------------------------------
                                    698 ;	src/main.c:122: void main(void){
                                    699 ;	-----------------------------------------
                                    700 ;	 function main
                                    701 ;	-----------------------------------------
      000179                        702 _main:
                                    703 ;	src/main.c:125: init_serial();
      000179 12 00 FF         [24]  704 	lcall	_init_serial
                                    705 ;	src/main.c:126: while(1){
      00017C                        706 00102$:
                                    707 ;	src/main.c:127: put_char('A');
      00017C 75 82 41         [24]  708 	mov	dpl, #0x41
      00017F 12 01 12         [24]  709 	lcall	_put_char
                                    710 ;	src/main.c:129: }
      000182 80 F8            [24]  711 	sjmp	00102$
                                    712 	.area CSEG    (CODE)
                                    713 	.area CONST   (CODE)
                                    714 	.area XINIT   (CODE)
