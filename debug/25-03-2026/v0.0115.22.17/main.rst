      ...
      00001C                        378 	.ds	7
      000023 02 01 54         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 75         [24]  461 	ljmp	_main
      ...
      000113 22               [24]  559 	ret
                                    ...
                                    562 ;------------------------------------------------------------
                                    563 ;args          Allocated to registers 
                                    564 ;------------------------------------------------------------
      ...
      000114 85 82 99         [24]  570 	mov	_SBUF,dpl
                                    571 ;	src/main.c:51: SBUF = args;
                                    572 ;	src/main.c:53: }
      000117 22               [24]  573 	ret
                                    574 ;------------------------------------------------------------
                                    575 ;Allocation info for local variables in function 'echo'
                                    576 ;------------------------------------------------------------
                                    577 ;	src/main.c:55: void echo(void){
                                    578 ;	-----------------------------------------
                                    579 ;	 function echo
                                    580 ;	-----------------------------------------
      000118                        581 _echo:
                                    582 ;	src/main.c:56: serial_busy = 1;
      000118 75 38 01         [24]  583 	mov	_serial_busy,#0x01
                                    584 ;	src/main.c:57: while(rd_pointer == wr_pointer);
      00011B                        585 00101$:
      00011B E5 33            [12]  586 	mov	a,_wr_pointer
      00011D B5 32 02         [24]  587 	cjne	a,_rd_pointer,00133$
      000120 80 F9            [24]  588 	sjmp	00101$
      000122                        589 00133$:
                                    590 ;	src/main.c:58: SBUF = *rd_pointer;
      000122 A9 32            [24]  591 	mov	r1,_rd_pointer
      000124 87 99            [24]  592 	mov	_SBUF,@r1
                                    593 ;	src/main.c:59: while(serial_busy);
      000126                        594 00104$:
      000126 E5 38            [12]  595 	mov	a,_serial_busy
      000128 70 FC            [24]  596 	jnz	00104$
                                    597 ;	src/main.c:60: rd_pointer++;
      00012A 05 32            [12]  598 	inc	_rd_pointer
                                    599 ;	src/main.c:62: }
      00012C 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    602 ;Allocation info for local variables in function 'delay_ms_500'
                                    603 ;------------------------------------------------------------
                                    604 ;	src/main.c:68: void delay_ms_500(void){
                                    605 ;	-----------------------------------------
                                    606 ;	 function delay_ms_500
                                    607 ;	-----------------------------------------
      00012D                        608 _delay_ms_500:
                                    609 ;	src/main.c:71: }
      00012D 22               [24]  610 	ret
                                    611 ;------------------------------------------------------------
                                    612 ;Allocation info for local variables in function 'ascii_to_hex'
                                    613 ;------------------------------------------------------------
                                    614 ;	src/main.c:76: void ascii_to_hex(void){
                                    615 ;	-----------------------------------------
                                    616 ;	 function ascii_to_hex
                                    617 ;	-----------------------------------------
      00012E                        618 _ascii_to_hex:
                                    619 ;	src/main.c:79: }
      00012E 22               [24]  620 	ret
                                    621 ;------------------------------------------------------------
                                    622 ;Allocation info for local variables in function 'hex_to_ascii'
                                    623 ;------------------------------------------------------------
                                    624 ;	src/main.c:85: void hex_to_ascii(void){
                                    625 ;	-----------------------------------------
                                    626 ;	 function hex_to_ascii
                                    627 ;	-----------------------------------------
      00012F                        628 _hex_to_ascii:
                                    629 ;	src/main.c:88: }
      00012F 22               [24]  630 	ret
                                    631 ;------------------------------------------------------------
                                    632 ;Allocation info for local variables in function 'print_boot_message'
                                    633 ;------------------------------------------------------------
                                    634 ;	src/main.c:93: void print_boot_message(void){
                                    635 ;	-----------------------------------------
                                    636 ;	 function print_boot_message
                                    637 ;	-----------------------------------------
      000130                        638 _print_boot_message:
                                    639 ;	src/main.c:95: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000130 75 82 44         [24]  640 	mov	dpl, #0x44
      000133 12 01 14         [24]  641 	lcall	_put_char
      000136 75 82 65         [24]  642 	mov	dpl, #0x65
      000139 12 01 14         [24]  643 	lcall	_put_char
      00013C 75 82 62         [24]  644 	mov	dpl, #0x62
      00013F 12 01 14         [24]  645 	lcall	_put_char
      000142 75 82 75         [24]  646 	mov	dpl, #0x75
      000145 12 01 14         [24]  647 	lcall	_put_char
      000148 75 82 67         [24]  648 	mov	dpl, #0x67
      00014B 12 01 14         [24]  649 	lcall	_put_char
      00014E 75 82 0A         [24]  650 	mov	dpl, #0x0a
                                    651 ;	src/main.c:97: }
      000151 02 01 14         [24]  652 	ljmp	_put_char
                                    653 ;------------------------------------------------------------
                                    654 ;Allocation info for local variables in function 'Serial_ISR'
                                    655 ;------------------------------------------------------------
                                    656 ;	src/main.c:105: void Serial_ISR(void) __interrupt (4)
                                    657 ;	-----------------------------------------
                                    658 ;	 function Serial_ISR
                                    659 ;	-----------------------------------------
      000154                        660 _Serial_ISR:
      000154 C0 E0            [24]  661 	push	acc
      000156 C0 00            [24]  662 	push	ar0
      000158 C0 D0            [24]  663 	push	psw
      00015A 75 D0 00         [24]  664 	mov	psw,#0x00
                                    665 ;	src/main.c:107: if(RI){						//Recieve Interrput == RI
      00015D 30 98 09         [24]  666 	jnb	_RI,00102$
                                    667 ;	src/main.c:108: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000160 E5 33            [12]  668 	mov	a,_wr_pointer
      000162 F8               [12]  669 	mov	r0,a
      000163 A6 99            [24]  670 	mov	@r0,_SBUF
                                    671 ;	src/main.c:109: wr_pointer++;
      000165 05 33            [12]  672 	inc	_wr_pointer
                                    673 ;	src/main.c:110: RI = 0;
                                    674 ;	assignBit
      000167 C2 98            [12]  675 	clr	_RI
      000169                        676 00102$:
                                    677 ;	src/main.c:113: if(TI){
                                    678 ;	src/main.c:115: TI = 0;
                                    679 ;	assignBit
      000169 10 99 02         [24]  680 	jbc	_TI,00120$
      00016C 80 00            [24]  681 	sjmp	00105$
      00016E                        682 00120$:
      00016E                        683 00105$:
                                    684 ;	src/main.c:118: }
      00016E D0 D0            [24]  685 	pop	psw
      000170 D0 00            [24]  686 	pop	ar0
      000172 D0 E0            [24]  687 	pop	acc
      000174 32               [24]  688 	reti
                                    ...
                                    695 ;------------------------------------------------------------
                                    696 ;	src/main.c:120: void main(void){
                                    697 ;	-----------------------------------------
                                    698 ;	 function main
                                    699 ;	-----------------------------------------
      000175                        700 _main:
                                    701 ;	src/main.c:121: init_mpu();
      000175 12 00 CB         [24]  702 	lcall	_init_mpu
                                    703 ;	src/main.c:123: init_serial();
      000178 12 00 FF         [24]  704 	lcall	_init_serial
                                    705 ;	src/main.c:125: while(1){
      00017B                        706 00102$:
                                    707 ;	src/main.c:126: put_char('A');
      00017B 75 82 41         [24]  708 	mov	dpl, #0x41
      00017E 12 01 14         [24]  709 	lcall	_put_char
                                    710 ;	src/main.c:129: }
      000181 80 F8            [24]  711 	sjmp	00102$
                                    712 	.area CSEG    (CODE)
                                    713 	.area CONST   (CODE)
                                    714 	.area XINIT   (CODE)
