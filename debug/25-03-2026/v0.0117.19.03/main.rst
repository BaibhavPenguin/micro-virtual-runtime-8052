      ...
      00001C                        411 	.ds	7
      000023 02 01 3E         [24]  412 	ljmp	_Serial_ISR
      000026                        413 	.ds	5
      00002B 02 01 6A         [24]  414 	ljmp	_Timer2_ISR
      ...
      000071 02 01 74         [24]  529 	ljmp	_main
      ...
      00013D                        679 _print_boot_message:
                                    680 ;	src/main.c:81: }
      00013D 22               [24]  681 	ret
                                    682 ;------------------------------------------------------------
                                    683 ;Allocation info for local variables in function 'Serial_ISR'
                                    684 ;------------------------------------------------------------
                                    685 ;	src/main.c:85: void Serial_ISR(void) __interrupt(4)
                                    686 ;	-----------------------------------------
                                    687 ;	 function Serial_ISR
                                    688 ;	-----------------------------------------
      00013E                        689 _Serial_ISR:
      00013E C0 E0            [24]  690 	push	acc
      000140 C0 82            [24]  691 	push	dpl
      000142 C0 83            [24]  692 	push	dph
      000144 C0 01            [24]  693 	push	ar1
      000146 C0 D0            [24]  694 	push	psw
      000148 75 D0 00         [24]  695 	mov	psw,#0x00
                                    696 ;	src/main.c:87: if(RI){
      00014B 30 98 11         [24]  697 	jnb	_RI,00103$
                                    698 ;	src/main.c:88: *wr_pointer = SBUF;
      00014E 90 00 33         [24]  699 	mov	dptr,#_wr_pointer
      000151 E0               [24]  700 	movx	a,@dptr
      000152 F9               [12]  701 	mov	r1,a
      000153 A7 99            [24]  702 	mov	@r1,_SBUF
                                    703 ;	src/main.c:89: is_recieved = 1;
                                    704 ;	assignBit
      000155 D2 00            [12]  705 	setb	_is_recieved
                                    706 ;	src/main.c:90: wr_pointer++;
      000157 90 00 33         [24]  707 	mov	dptr,#_wr_pointer
      00015A E9               [12]  708 	mov	a,r1
      00015B 04               [12]  709 	inc	a
      00015C F0               [24]  710 	movx	@dptr,a
                                    711 ;	src/main.c:91: RI = 0;
                                    712 ;	assignBit
      00015D C2 98            [12]  713 	clr	_RI
      00015F                        714 00103$:
                                    715 ;	src/main.c:93: }
      00015F D0 D0            [24]  716 	pop	psw
      000161 D0 01            [24]  717 	pop	ar1
      000163 D0 83            [24]  718 	pop	dph
      000165 D0 82            [24]  719 	pop	dpl
      000167 D0 E0            [24]  720 	pop	acc
      000169 32               [24]  721 	reti
                                    722 ;	eliminated unneeded push/pop ar0
                                    723 ;	eliminated unneeded push/pop b
                                    724 ;------------------------------------------------------------
                                    725 ;Allocation info for local variables in function 'Timer2_ISR'
                                    726 ;------------------------------------------------------------
                                    727 ;	src/main.c:95: void Timer2_ISR(void) __interrupt(5)
                                    728 ;	-----------------------------------------
                                    729 ;	 function Timer2_ISR
                                    730 ;	-----------------------------------------
      00016A                        731 _Timer2_ISR:
      00016A C0 E0            [24]  732 	push	acc
                                    733 ;	src/main.c:97: system_tick++;
      00016C E5 34            [12]  734 	mov	a,_system_tick
      00016E 04               [12]  735 	inc	a
      00016F F5 34            [12]  736 	mov	_system_tick,a
                                    737 ;	src/main.c:98: }
      000171 D0 E0            [24]  738 	pop	acc
      000173 32               [24]  739 	reti
                                    740 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    741 ;	eliminated unneeded push/pop not_psw
                                    742 ;	eliminated unneeded push/pop dpl
                                    743 ;	eliminated unneeded push/pop dph
                                    744 ;	eliminated unneeded push/pop b
                                    745 ;------------------------------------------------------------
                                    746 ;Allocation info for local variables in function 'main'
                                    747 ;------------------------------------------------------------
                                    748 ;	src/main.c:101: void main(void){
                                    749 ;	-----------------------------------------
                                    750 ;	 function main
                                    751 ;	-----------------------------------------
      000174                        752 _main:
                                    753 ;	src/main.c:102: SP = hw_stack; 		//initiaslze Stack Pointer;
      000174 75 81 60         [24]  754 	mov	_SP,#0x60
                                    755 ;	src/main.c:103: init_sys();
      000177 12 01 04         [24]  756 	lcall	_init_sys
                                    757 ;	src/main.c:104: init_serial();
      00017A 12 01 1F         [24]  758 	lcall	_init_serial
                                    759 ;	src/main.c:105: while(1){
      00017D                        760 00102$:
                                    761 ;	src/main.c:106: uart_send('H');
      00017D 75 82 48         [24]  762 	mov	dpl, #0x48
      000180 12 01 30         [24]  763 	lcall	_uart_send
                                    764 ;	src/main.c:107: uart_send('e');
      000183 75 82 65         [24]  765 	mov	dpl, #0x65
      000186 12 01 30         [24]  766 	lcall	_uart_send
                                    767 ;	src/main.c:108: uart_send('l');
      000189 75 82 6C         [24]  768 	mov	dpl, #0x6c
      00018C 12 01 30         [24]  769 	lcall	_uart_send
                                    770 ;	src/main.c:109: uart_send('l');
      00018F 75 82 6C         [24]  771 	mov	dpl, #0x6c
      000192 12 01 30         [24]  772 	lcall	_uart_send
                                    773 ;	src/main.c:110: uart_send('o');
      000195 75 82 6F         [24]  774 	mov	dpl, #0x6f
      000198 12 01 30         [24]  775 	lcall	_uart_send
                                    776 ;	src/main.c:111: uart_send(' ');
      00019B 75 82 20         [24]  777 	mov	dpl, #0x20
      00019E 12 01 30         [24]  778 	lcall	_uart_send
                                    779 ;	src/main.c:113: }
      0001A1 80 DA            [24]  780 	sjmp	00102$
                                    781 	.area CSEG    (CODE)
                                    782 	.area CONST   (CODE)
                                    783 	.area XINIT   (CODE)
