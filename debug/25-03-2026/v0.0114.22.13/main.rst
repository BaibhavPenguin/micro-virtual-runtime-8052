      ...
      00001C                        378 	.ds	7
      000023 02 01 57         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 73         [24]  461 	ljmp	_main
      ...
      000115                        570 00101$:
                                    571 ;	src/main.c:53: TI = 0;
                                    572 ;	assignBit
      000115 10 99 02         [24]  573 	jbc	_TI,00118$
      000118 80 FB            [24]  574 	sjmp	00101$
      00011A                        575 00118$:
                                    576 ;	src/main.c:55: }
      00011A 22               [24]  577 	ret
                                    578 ;------------------------------------------------------------
                                    579 ;Allocation info for local variables in function 'echo'
                                    580 ;------------------------------------------------------------
                                    581 ;	src/main.c:57: void echo(void){
                                    582 ;	-----------------------------------------
                                    583 ;	 function echo
                                    584 ;	-----------------------------------------
      00011B                        585 _echo:
                                    586 ;	src/main.c:58: serial_busy = 1;
      00011B 75 38 01         [24]  587 	mov	_serial_busy,#0x01
                                    588 ;	src/main.c:59: while(rd_pointer == wr_pointer);
      00011E                        589 00101$:
      00011E E5 33            [12]  590 	mov	a,_wr_pointer
      000120 B5 32 02         [24]  591 	cjne	a,_rd_pointer,00133$
      000123 80 F9            [24]  592 	sjmp	00101$
      000125                        593 00133$:
                                    594 ;	src/main.c:60: SBUF = *rd_pointer;
      000125 A9 32            [24]  595 	mov	r1,_rd_pointer
      000127 87 99            [24]  596 	mov	_SBUF,@r1
                                    597 ;	src/main.c:61: while(serial_busy);
      000129                        598 00104$:
      000129 E5 38            [12]  599 	mov	a,_serial_busy
      00012B 70 FC            [24]  600 	jnz	00104$
                                    601 ;	src/main.c:62: rd_pointer++;
      00012D 05 32            [12]  602 	inc	_rd_pointer
                                    603 ;	src/main.c:64: }
      00012F 22               [24]  604 	ret
                                    605 ;------------------------------------------------------------
                                    606 ;Allocation info for local variables in function 'delay_ms_500'
                                    607 ;------------------------------------------------------------
                                    608 ;	src/main.c:70: void delay_ms_500(void){
                                    609 ;	-----------------------------------------
                                    610 ;	 function delay_ms_500
                                    611 ;	-----------------------------------------
      000130                        612 _delay_ms_500:
                                    613 ;	src/main.c:73: }
      000130 22               [24]  614 	ret
                                    615 ;------------------------------------------------------------
                                    616 ;Allocation info for local variables in function 'ascii_to_hex'
                                    617 ;------------------------------------------------------------
                                    618 ;	src/main.c:78: void ascii_to_hex(void){
                                    619 ;	-----------------------------------------
                                    620 ;	 function ascii_to_hex
                                    621 ;	-----------------------------------------
      000131                        622 _ascii_to_hex:
                                    623 ;	src/main.c:81: }
      000131 22               [24]  624 	ret
                                    625 ;------------------------------------------------------------
                                    626 ;Allocation info for local variables in function 'hex_to_ascii'
                                    627 ;------------------------------------------------------------
                                    628 ;	src/main.c:87: void hex_to_ascii(void){
                                    629 ;	-----------------------------------------
                                    630 ;	 function hex_to_ascii
                                    631 ;	-----------------------------------------
      000132                        632 _hex_to_ascii:
                                    633 ;	src/main.c:90: }
      000132 22               [24]  634 	ret
                                    635 ;------------------------------------------------------------
                                    636 ;Allocation info for local variables in function 'print_boot_message'
                                    637 ;------------------------------------------------------------
                                    638 ;	src/main.c:95: void print_boot_message(void){
                                    639 ;	-----------------------------------------
                                    640 ;	 function print_boot_message
                                    641 ;	-----------------------------------------
      000133                        642 _print_boot_message:
                                    643 ;	src/main.c:97: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000133 75 82 44         [24]  644 	mov	dpl, #0x44
      000136 12 01 12         [24]  645 	lcall	_put_char
      000139 75 82 65         [24]  646 	mov	dpl, #0x65
      00013C 12 01 12         [24]  647 	lcall	_put_char
      00013F 75 82 62         [24]  648 	mov	dpl, #0x62
      000142 12 01 12         [24]  649 	lcall	_put_char
      000145 75 82 75         [24]  650 	mov	dpl, #0x75
      000148 12 01 12         [24]  651 	lcall	_put_char
      00014B 75 82 67         [24]  652 	mov	dpl, #0x67
      00014E 12 01 12         [24]  653 	lcall	_put_char
      000151 75 82 0A         [24]  654 	mov	dpl, #0x0a
                                    655 ;	src/main.c:99: }
      000154 02 01 12         [24]  656 	ljmp	_put_char
                                    657 ;------------------------------------------------------------
                                    658 ;Allocation info for local variables in function 'Serial_ISR'
                                    659 ;------------------------------------------------------------
                                    660 ;	src/main.c:107: void Serial_ISR(void) __interrupt (4)
                                    661 ;	-----------------------------------------
                                    662 ;	 function Serial_ISR
                                    663 ;	-----------------------------------------
      000157                        664 _Serial_ISR:
      000157 C0 E0            [24]  665 	push	acc
      000159 C0 00            [24]  666 	push	ar0
      00015B C0 D0            [24]  667 	push	psw
      00015D 75 D0 00         [24]  668 	mov	psw,#0x00
                                    669 ;	src/main.c:109: if(RI){						//Recieve Interrput == RI
      000160 30 98 09         [24]  670 	jnb	_RI,00103$
                                    671 ;	src/main.c:110: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000163 E5 33            [12]  672 	mov	a,_wr_pointer
      000165 F8               [12]  673 	mov	r0,a
      000166 A6 99            [24]  674 	mov	@r0,_SBUF
                                    675 ;	src/main.c:111: wr_pointer++;
      000168 05 33            [12]  676 	inc	_wr_pointer
                                    677 ;	src/main.c:112: RI = 0;
                                    678 ;	assignBit
      00016A C2 98            [12]  679 	clr	_RI
      00016C                        680 00103$:
                                    681 ;	src/main.c:114: }
      00016C D0 D0            [24]  682 	pop	psw
      00016E D0 00            [24]  683 	pop	ar0
      000170 D0 E0            [24]  684 	pop	acc
      000172 32               [24]  685 	reti
                                    686 ;	eliminated unneeded push/pop ar1
                                    687 ;	eliminated unneeded push/pop dpl
                                    688 ;	eliminated unneeded push/pop dph
                                    689 ;	eliminated unneeded push/pop b
                                    690 ;------------------------------------------------------------
                                    691 ;Allocation info for local variables in function 'main'
                                    692 ;------------------------------------------------------------
                                    693 ;	src/main.c:116: void main(void){
                                    694 ;	-----------------------------------------
                                    695 ;	 function main
                                    696 ;	-----------------------------------------
      000173                        697 _main:
                                    698 ;	src/main.c:119: init_serial();
      000173 12 00 FF         [24]  699 	lcall	_init_serial
                                    700 ;	src/main.c:120: while(1){
      000176                        701 00102$:
                                    702 ;	src/main.c:121: put_char('A');
      000176 75 82 41         [24]  703 	mov	dpl, #0x41
      000179 12 01 12         [24]  704 	lcall	_put_char
                                    705 ;	src/main.c:123: }
      00017C 80 F8            [24]  706 	sjmp	00102$
                                    707 	.area CSEG    (CODE)
                                    708 	.area CONST   (CODE)
                                    709 	.area XINIT   (CODE)
