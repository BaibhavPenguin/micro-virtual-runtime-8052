      ...
      00001C                        378 	.ds	7
      000023 02 01 45         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 68         [24]  461 	ljmp	_main
      ...
      0000E5 75 37 00         [24]  503 	mov	_active_timer,#0x00
                                    ...
                                    505 ;	assignBit
      0000E8 C2 00            [12]  506 	clr	_serial_busy
                                    507 ;	src/main.c:21: temp1 = 00;
      0000EA 75 39 00         [24]  508 	mov	_temp1,#0x00
                                    509 ;	src/main.c:22: temp2 = 00;
      0000ED 75 3A 00         [24]  510 	mov	_temp2,#0x00
                                    511 ;	src/main.c:23: temp3 = 00;
      0000F0 75 3C 00         [24]  512 	mov	_temp3,#0x00
                                    513 ;	src/main.c:24: instruction_buffer = 00;
      0000F3 75 3D 00         [24]  514 	mov	_instruction_buffer,#0x00
                                    515 ;	src/main.c:25: result_l = 00;
      0000F6 75 3E 00         [24]  516 	mov	_result_l,#0x00
                                    517 ;	src/main.c:26: result_h = 00;
      0000F9 75 3F 00         [24]  518 	mov	_result_h,#0x00
                                    519 ;	src/main.c:27: }
      0000FC 22               [24]  520 	ret
                                    521 ;------------------------------------------------------------
                                    522 ;Allocation info for local variables in function 'init_timer'
                                    523 ;------------------------------------------------------------
                                    524 ;	src/main.c:31: void init_timer(void){
                                    525 ;	-----------------------------------------
                                    526 ;	 function init_timer
                                    527 ;	-----------------------------------------
      0000FD                        528 _init_timer:
                                    529 ;	src/main.c:33: }
      0000FD 22               [24]  530 	ret
                                    531 ;------------------------------------------------------------
                                    532 ;Allocation info for local variables in function 'init_serial'
                                    533 ;------------------------------------------------------------
                                    534 ;	src/main.c:36: void init_serial(void){
                                    535 ;	-----------------------------------------
                                    536 ;	 function init_serial
                                    537 ;	-----------------------------------------
      0000FE                        538 _init_serial:
                                    539 ;	src/main.c:38: TMOD = 0x20;				//Set TMOD to Use Timer 1 in 8 Bit Auto Reload
      0000FE 75 89 20         [24]  540 	mov	_TMOD,#0x20
                                    541 ;	src/main.c:39: TH1 = serial_baud_timer;	//Set Reload value
      000101 75 8D FD         [24]  542 	mov	_TH1,#0xfd
                                    543 ;	src/main.c:40: TL1 = serial_baud_timer;	//Set Initial Value
      000104 75 8B FD         [24]  544 	mov	_TL1,#0xfd
                                    545 ;	src/main.c:41: TR1 = 1;					//Start Timer 1
                                    546 ;	assignBit
      000107 D2 8E            [12]  547 	setb	_TR1
                                    548 ;	src/main.c:42: TI = 0;
                                    549 ;	assignBit
      000109 C2 99            [12]  550 	clr	_TI
                                    551 ;	src/main.c:43: RI = 0;
                                    552 ;	assignBit
      00010B C2 98            [12]  553 	clr	_RI
                                    554 ;	src/main.c:44: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
      00010D 75 98 50         [24]  555 	mov	_SCON,#0x50
                                    556 ;	src/main.c:45: ES = 1;						//Enable Serial interrupt
                                    557 ;	assignBit
      000110 D2 AC            [12]  558 	setb	_ES
                                    559 ;	src/main.c:47: }
      000112 22               [24]  560 	ret
                                    561 ;------------------------------------------------------------
                                    562 ;Allocation info for local variables in function 'put_char'
                                    563 ;------------------------------------------------------------
                                    564 ;args          Allocated to registers r7 
                                    565 ;------------------------------------------------------------
                                    566 ;	src/main.c:50: void put_char(char args){
                                    567 ;	-----------------------------------------
                                    568 ;	 function put_char
                                    569 ;	-----------------------------------------
      000113                        570 _put_char:
      000113 AF 82            [24]  571 	mov	r7, dpl
                                    572 ;	src/main.c:51: while(serial_busy);
      000115                        573 00101$:
      000115 20 00 FD         [24]  574 	jb	_serial_busy,00101$
                                    575 ;	src/main.c:52: serial_busy = 1;
                                    576 ;	assignBit
      000118 D2 00            [12]  577 	setb	_serial_busy
                                    578 ;	src/main.c:53: SBUF = args;
      00011A 8F 99            [24]  579 	mov	_SBUF,r7
                                    580 ;	src/main.c:55: }
      00011C 22               [24]  581 	ret
                                    582 ;------------------------------------------------------------
                                    583 ;Allocation info for local variables in function 'echo'
                                    584 ;------------------------------------------------------------
                                    585 ;	src/main.c:57: void echo(void){
                                    586 ;	-----------------------------------------
                                    587 ;	 function echo
                                    588 ;	-----------------------------------------
      00011D                        589 _echo:
                                    590 ;	src/main.c:59: }
      00011D 22               [24]  591 	ret
                                    592 ;------------------------------------------------------------
                                    593 ;Allocation info for local variables in function 'delay_ms_500'
                                    594 ;------------------------------------------------------------
                                    595 ;	src/main.c:65: void delay_ms_500(void){
                                    596 ;	-----------------------------------------
                                    597 ;	 function delay_ms_500
                                    598 ;	-----------------------------------------
      00011E                        599 _delay_ms_500:
                                    600 ;	src/main.c:68: }
      00011E 22               [24]  601 	ret
                                    602 ;------------------------------------------------------------
                                    603 ;Allocation info for local variables in function 'ascii_to_hex'
                                    604 ;------------------------------------------------------------
                                    605 ;	src/main.c:73: void ascii_to_hex(void){
                                    606 ;	-----------------------------------------
                                    607 ;	 function ascii_to_hex
                                    608 ;	-----------------------------------------
      00011F                        609 _ascii_to_hex:
                                    610 ;	src/main.c:76: }
      00011F 22               [24]  611 	ret
                                    612 ;------------------------------------------------------------
                                    613 ;Allocation info for local variables in function 'hex_to_ascii'
                                    614 ;------------------------------------------------------------
                                    615 ;	src/main.c:82: void hex_to_ascii(void){
                                    616 ;	-----------------------------------------
                                    617 ;	 function hex_to_ascii
                                    618 ;	-----------------------------------------
      000120                        619 _hex_to_ascii:
                                    620 ;	src/main.c:85: }
      000120 22               [24]  621 	ret
                                    622 ;------------------------------------------------------------
                                    623 ;Allocation info for local variables in function 'print_boot_message'
                                    624 ;------------------------------------------------------------
                                    625 ;	src/main.c:90: void print_boot_message(void){
                                    626 ;	-----------------------------------------
                                    627 ;	 function print_boot_message
                                    628 ;	-----------------------------------------
      000121                        629 _print_boot_message:
                                    630 ;	src/main.c:92: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000121 75 82 44         [24]  631 	mov	dpl, #0x44
      000124 12 01 13         [24]  632 	lcall	_put_char
      000127 75 82 65         [24]  633 	mov	dpl, #0x65
      00012A 12 01 13         [24]  634 	lcall	_put_char
      00012D 75 82 62         [24]  635 	mov	dpl, #0x62
      000130 12 01 13         [24]  636 	lcall	_put_char
      000133 75 82 75         [24]  637 	mov	dpl, #0x75
      000136 12 01 13         [24]  638 	lcall	_put_char
      000139 75 82 67         [24]  639 	mov	dpl, #0x67
      00013C 12 01 13         [24]  640 	lcall	_put_char
      00013F 75 82 0A         [24]  641 	mov	dpl, #0x0a
                                    642 ;	src/main.c:94: }
      000142 02 01 13         [24]  643 	ljmp	_put_char
                                    644 ;------------------------------------------------------------
                                    645 ;Allocation info for local variables in function 'Serial_ISR'
                                    646 ;------------------------------------------------------------
                                    647 ;	src/main.c:102: void Serial_ISR(void) __interrupt (4)
                                    648 ;	-----------------------------------------
                                    649 ;	 function Serial_ISR
                                    650 ;	-----------------------------------------
      000145                        651 _Serial_ISR:
      000145 C0 E0            [24]  652 	push	acc
      000147 C0 00            [24]  653 	push	ar0
      000149 C0 D0            [24]  654 	push	psw
      00014B 75 D0 00         [24]  655 	mov	psw,#0x00
                                    656 ;	src/main.c:104: if(RI){						//Recieve Interrput == RI
      00014E 30 98 09         [24]  657 	jnb	_RI,00102$
                                    658 ;	src/main.c:105: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000151 E5 33            [12]  659 	mov	a,_wr_pointer
      000153 F8               [12]  660 	mov	r0,a
      000154 A6 99            [24]  661 	mov	@r0,_SBUF
                                    662 ;	src/main.c:106: wr_pointer++;
      000156 05 33            [12]  663 	inc	_wr_pointer
                                    664 ;	src/main.c:107: RI = 0;
                                    665 ;	assignBit
      000158 C2 98            [12]  666 	clr	_RI
      00015A                        667 00102$:
                                    668 ;	src/main.c:110: if(TI){
                                    669 ;	src/main.c:112: TI = 0;
                                    670 ;	assignBit
      00015A 10 99 02         [24]  671 	jbc	_TI,00120$
      00015D 80 02            [24]  672 	sjmp	00105$
      00015F                        673 00120$:
                                    674 ;	src/main.c:113: serial_busy = 0;
                                    675 ;	assignBit
      00015F C2 00            [12]  676 	clr	_serial_busy
      000161                        677 00105$:
                                    678 ;	src/main.c:115: }
      000161 D0 D0            [24]  679 	pop	psw
      000163 D0 00            [24]  680 	pop	ar0
      000165 D0 E0            [24]  681 	pop	acc
      000167 32               [24]  682 	reti
                                    683 ;	eliminated unneeded push/pop ar1
                                    684 ;	eliminated unneeded push/pop dpl
                                    685 ;	eliminated unneeded push/pop dph
                                    686 ;	eliminated unneeded push/pop b
                                    687 ;------------------------------------------------------------
                                    688 ;Allocation info for local variables in function 'main'
                                    689 ;------------------------------------------------------------
                                    690 ;	src/main.c:117: void main(void){
                                    691 ;	-----------------------------------------
                                    692 ;	 function main
                                    693 ;	-----------------------------------------
      000168                        694 _main:
                                    695 ;	src/main.c:118: init_mpu();
      000168 12 00 CB         [24]  696 	lcall	_init_mpu
                                    697 ;	src/main.c:120: init_serial();
      00016B 12 00 FE         [24]  698 	lcall	_init_serial
                                    699 ;	src/main.c:122: while(1){
      00016E                        700 00102$:
                                    701 ;	src/main.c:123: put_char('A');
      00016E 75 82 41         [24]  702 	mov	dpl, #0x41
      000171 12 01 13         [24]  703 	lcall	_put_char
                                    704 ;	src/main.c:126: }
      000174 80 F8            [24]  705 	sjmp	00102$
                                    706 	.area CSEG    (CODE)
                                    707 	.area CONST   (CODE)
                                    708 	.area XINIT   (CODE)
