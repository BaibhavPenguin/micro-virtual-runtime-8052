...
;------------------------------------------------------------
;	src/main.c:11: void init_timer(void){
;	-----------------------------------------
;	 function init_timer
;	-----------------------------------------
_init_timer:
...
;------------------------------------------------------------
;	src/main.c:16: void init_serial(void){
;	-----------------------------------------
;	 function init_serial
;	-----------------------------------------
_init_serial:
;	src/main.c:18: TMOD = 0x20;				//Set TMOD to Use Timer 1 in 8 Bit Auto Reload
	mov	_TMOD,#0x20
;	src/main.c:19: TH1 = serial_baud_timer;	//Set Reload value
	mov	_TH1,#0xfd
;	src/main.c:20: TL1 = serial_baud_timer;	//Set Initial Value
	mov	_TL1,#0xfd
;	src/main.c:21: TR1 = 1;					//Start Timer 1
;	assignBit
	setb	_TR1
;	src/main.c:22: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
	mov	_SCON,#0x50
;	src/main.c:23: ES = 0;
;	assignBit
	clr	_ES
...
;------------------------------------------------------------
;	src/main.c:43: void delay_ms_500(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	src/main.c:51: void ascii_to_hex(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	src/main.c:60: void hex_to_ascii(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	src/main.c:68: void print_boot_message(void){
;	-----------------------------------------
;	 function print_boot_message
;	-----------------------------------------
_print_boot_message:
;	src/main.c:70: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
	mov	dpl, #0x44
	lcall	_put_char
	mov	dpl, #0x65
	lcall	_put_char
...
;	-----------------------------------------
_main:
;	src/main.c:81: SP = hw_stack; 		//initiaslze Stack Pointer;
	mov	_SP,#0x60
;	src/main.c:82: init_serial();
	lcall	_init_serial
;	src/main.c:83: while(1){
00102$:
;	src/main.c:84: put_char('A');
	mov	dpl, #0x41
	lcall	_put_char
;	src/main.c:86: }
	sjmp	00102$
