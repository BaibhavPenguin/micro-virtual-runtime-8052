      ...
      00001C                        378 	.ds	7
      000023 02 01 5B         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 7F         [24]  461 	ljmp	_main
      ...
      0000FA 75 3F 00         [24]  517 	mov	_result_h,#0x00
                                    518 ;	src/main.c:27: return;
                                    519 ;	src/main.c:28: }
      0000FD 22               [24]  520 	ret
                                    521 ;------------------------------------------------------------
                                    522 ;Allocation info for local variables in function 'init_timer'
                                    523 ;------------------------------------------------------------
                                    524 ;	src/main.c:32: void init_timer(void){
                                    525 ;	-----------------------------------------
                                    526 ;	 function init_timer
                                    527 ;	-----------------------------------------
      0000FE                        528 _init_timer:
                                    529 ;	src/main.c:34: }
      0000FE 22               [24]  530 	ret
                                    531 ;------------------------------------------------------------
                                    532 ;Allocation info for local variables in function 'init_serial'
                                    533 ;------------------------------------------------------------
                                    534 ;	src/main.c:37: void init_serial(void){
                                    535 ;	-----------------------------------------
                                    536 ;	 function init_serial
                                    537 ;	-----------------------------------------
      0000FF                        538 _init_serial:
                                    539 ;	src/main.c:39: TMOD = 0x20;				//Set TMOD to Use Timer 1 in 8 Bit Auto Reload
      0000FF 75 89 20         [24]  540 	mov	_TMOD,#0x20
                                    541 ;	src/main.c:40: TH1 = serial_baud_timer;	//Set Reload value
      000102 75 8D FD         [24]  542 	mov	_TH1,#0xfd
                                    543 ;	src/main.c:41: TL1 = serial_baud_timer;	//Set Initial Value
      000105 75 8B FD         [24]  544 	mov	_TL1,#0xfd
                                    545 ;	src/main.c:42: TR1 = 1;					//Start Timer 1
                                    546 ;	assignBit
      000108 D2 8E            [12]  547 	setb	_TR1
                                    548 ;	src/main.c:43: serial_busy = 0x00;
      00010A 75 38 00         [24]  549 	mov	_serial_busy,#0x00
                                    550 ;	src/main.c:44: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
      00010D 75 98 50         [24]  551 	mov	_SCON,#0x50
                                    552 ;	src/main.c:45: ES = 1;						//Enable Serial interrupt
                                    553 ;	assignBit
      000110 D2 AC            [12]  554 	setb	_ES
                                    555 ;	src/main.c:47: }
      000112 22               [24]  556 	ret
                                    557 ;------------------------------------------------------------
                                    558 ;Allocation info for local variables in function 'put_char'
                                    559 ;------------------------------------------------------------
                                    560 ;args          Allocated to registers r7 
                                    561 ;------------------------------------------------------------
                                    562 ;	src/main.c:50: void put_char(char args){
                                    563 ;	-----------------------------------------
                                    564 ;	 function put_char
                                    565 ;	-----------------------------------------
      000113                        566 _put_char:
      000113 AF 82            [24]  567 	mov	r7, dpl
                                    568 ;	src/main.c:51: while(serial_busy);
      000115                        569 00101$:
      000115 E5 38            [12]  570 	mov	a,_serial_busy
      000117 70 FC            [24]  571 	jnz	00101$
                                    572 ;	src/main.c:52: serial_busy = 0x01;
      000119 75 38 01         [24]  573 	mov	_serial_busy,#0x01
                                    574 ;	src/main.c:53: SBUF = args;
      00011C 8F 99            [24]  575 	mov	_SBUF,r7
                                    576 ;	src/main.c:56: }
      00011E 22               [24]  577 	ret
                                    578 ;------------------------------------------------------------
                                    579 ;Allocation info for local variables in function 'echo'
                                    580 ;------------------------------------------------------------
                                    581 ;	src/main.c:58: void echo(void){
                                    582 ;	-----------------------------------------
                                    583 ;	 function echo
                                    584 ;	-----------------------------------------
      00011F                        585 _echo:
                                    586 ;	src/main.c:59: serial_busy = 1;
      00011F 75 38 01         [24]  587 	mov	_serial_busy,#0x01
                                    588 ;	src/main.c:60: while(rd_pointer == wr_pointer);
      000122                        589 00101$:
      000122 E5 33            [12]  590 	mov	a,_wr_pointer
      000124 B5 32 02         [24]  591 	cjne	a,_rd_pointer,00133$
      000127 80 F9            [24]  592 	sjmp	00101$
      000129                        593 00133$:
                                    594 ;	src/main.c:61: SBUF = *rd_pointer;
      000129 A9 32            [24]  595 	mov	r1,_rd_pointer
      00012B 87 99            [24]  596 	mov	_SBUF,@r1
                                    597 ;	src/main.c:62: while(serial_busy);
      00012D                        598 00104$:
      00012D E5 38            [12]  599 	mov	a,_serial_busy
      00012F 70 FC            [24]  600 	jnz	00104$
                                    601 ;	src/main.c:63: rd_pointer++;
      000131 05 32            [12]  602 	inc	_rd_pointer
                                    603 ;	src/main.c:65: }
      000133 22               [24]  604 	ret
                                    605 ;------------------------------------------------------------
                                    606 ;Allocation info for local variables in function 'delay_ms_500'
                                    607 ;------------------------------------------------------------
                                    608 ;	src/main.c:71: void delay_ms_500(void){
                                    609 ;	-----------------------------------------
                                    610 ;	 function delay_ms_500
                                    611 ;	-----------------------------------------
      000134                        612 _delay_ms_500:
                                    613 ;	src/main.c:74: }
      000134 22               [24]  614 	ret
                                    615 ;------------------------------------------------------------
                                    616 ;Allocation info for local variables in function 'ascii_to_hex'
                                    617 ;------------------------------------------------------------
                                    618 ;	src/main.c:79: void ascii_to_hex(void){
                                    619 ;	-----------------------------------------
                                    620 ;	 function ascii_to_hex
                                    621 ;	-----------------------------------------
      000135                        622 _ascii_to_hex:
                                    623 ;	src/main.c:82: }
      000135 22               [24]  624 	ret
                                    625 ;------------------------------------------------------------
                                    626 ;Allocation info for local variables in function 'hex_to_ascii'
                                    627 ;------------------------------------------------------------
                                    628 ;	src/main.c:88: void hex_to_ascii(void){
                                    629 ;	-----------------------------------------
                                    630 ;	 function hex_to_ascii
                                    631 ;	-----------------------------------------
      000136                        632 _hex_to_ascii:
                                    633 ;	src/main.c:91: }
      000136 22               [24]  634 	ret
                                    635 ;------------------------------------------------------------
                                    636 ;Allocation info for local variables in function 'print_boot_message'
                                    637 ;------------------------------------------------------------
                                    638 ;	src/main.c:96: void print_boot_message(void){
                                    639 ;	-----------------------------------------
                                    640 ;	 function print_boot_message
                                    641 ;	-----------------------------------------
      000137                        642 _print_boot_message:
                                    643 ;	src/main.c:98: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000137 75 82 44         [24]  644 	mov	dpl, #0x44
      00013A 12 01 13         [24]  645 	lcall	_put_char
      00013D 75 82 65         [24]  646 	mov	dpl, #0x65
      000140 12 01 13         [24]  647 	lcall	_put_char
      000143 75 82 62         [24]  648 	mov	dpl, #0x62
      000146 12 01 13         [24]  649 	lcall	_put_char
      000149 75 82 75         [24]  650 	mov	dpl, #0x75
      00014C 12 01 13         [24]  651 	lcall	_put_char
      00014F 75 82 67         [24]  652 	mov	dpl, #0x67
      000152 12 01 13         [24]  653 	lcall	_put_char
      000155 75 82 0A         [24]  654 	mov	dpl, #0x0a
                                    655 ;	src/main.c:100: }
      000158 02 01 13         [24]  656 	ljmp	_put_char
                                    657 ;------------------------------------------------------------
                                    658 ;Allocation info for local variables in function 'Serial_ISR'
                                    659 ;------------------------------------------------------------
                                    660 ;	src/main.c:108: void Serial_ISR(void) __interrupt (4)
                                    661 ;	-----------------------------------------
                                    662 ;	 function Serial_ISR
                                    663 ;	-----------------------------------------
      00015B                        664 _Serial_ISR:
      00015B C0 E0            [24]  665 	push	acc
      00015D C0 00            [24]  666 	push	ar0
      00015F C0 D0            [24]  667 	push	psw
      000161 75 D0 00         [24]  668 	mov	psw,#0x00
                                    669 ;	src/main.c:110: if(RI){						//Recieve Interrput == RI
      000164 30 98 09         [24]  670 	jnb	_RI,00102$
                                    671 ;	src/main.c:111: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000167 E5 33            [12]  672 	mov	a,_wr_pointer
      000169 F8               [12]  673 	mov	r0,a
      00016A A6 99            [24]  674 	mov	@r0,_SBUF
                                    675 ;	src/main.c:112: wr_pointer++;
      00016C 05 33            [12]  676 	inc	_wr_pointer
                                    677 ;	src/main.c:113: RI = 0;
                                    678 ;	assignBit
      00016E C2 98            [12]  679 	clr	_RI
      000170                        680 00102$:
                                    681 ;	src/main.c:116: if(TI){
                                    682 ;	src/main.c:117: TI = 0;
                                    683 ;	assignBit
      000170 10 99 02         [24]  684 	jbc	_TI,00120$
      000173 80 03            [24]  685 	sjmp	00105$
      000175                        686 00120$:
                                    687 ;	src/main.c:118: serial_busy = 0;
      000175 75 38 00         [24]  688 	mov	_serial_busy,#0x00
      000178                        689 00105$:
                                    690 ;	src/main.c:120: }
      000178 D0 D0            [24]  691 	pop	psw
      00017A D0 00            [24]  692 	pop	ar0
      00017C D0 E0            [24]  693 	pop	acc
      00017E 32               [24]  694 	reti
                                    695 ;	eliminated unneeded push/pop ar1
                                    696 ;	eliminated unneeded push/pop dpl
                                    697 ;	eliminated unneeded push/pop dph
                                    698 ;	eliminated unneeded push/pop b
                                    699 ;------------------------------------------------------------
                                    700 ;Allocation info for local variables in function 'main'
                                    701 ;------------------------------------------------------------
                                    702 ;	src/main.c:122: void main(void){
                                    703 ;	-----------------------------------------
                                    704 ;	 function main
                                    705 ;	-----------------------------------------
      00017F                        706 _main:
                                    707 ;	src/main.c:123: init_mpu();
      00017F 12 00 CB         [24]  708 	lcall	_init_mpu
                                    709 ;	src/main.c:125: init_serial();
      000182 12 00 FF         [24]  710 	lcall	_init_serial
                                    711 ;	src/main.c:126: while(1){
      000185                        712 00102$:
                                    713 ;	src/main.c:127: put_char('A');
      000185 75 82 41         [24]  714 	mov	dpl, #0x41
      000188 12 01 13         [24]  715 	lcall	_put_char
                                    716 ;	src/main.c:129: }
      00018B 80 F8            [24]  717 	sjmp	00102$
                                    718 	.area CSEG    (CODE)
                                    719 	.area CONST   (CODE)
                                    720 	.area XINIT   (CODE)
