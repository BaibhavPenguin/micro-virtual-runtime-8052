      ...
      00001C                        378 	.ds	7
      000023 02 01 52         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 76         [24]  461 	ljmp	_main
      ...
      00010D D2 AC            [12]  552 	setb	_ES
                                    553 ;	src/main.c:46: EA = 1;
                                    554 ;	assignBit
      00010F D2 AF            [12]  555 	setb	_EA
                                    556 ;	src/main.c:47: }
      000111 22               [24]  557 	ret
                                    558 ;------------------------------------------------------------
                                    559 ;Allocation info for local variables in function 'put_char'
                                    560 ;------------------------------------------------------------
                                    561 ;args          Allocated to registers 
                                    562 ;------------------------------------------------------------
                                    563 ;	src/main.c:50: void put_char(char args){
                                    564 ;	-----------------------------------------
                                    565 ;	 function put_char
                                    566 ;	-----------------------------------------
      000112                        567 _put_char:
      000112 85 82 99         [24]  568 	mov	_SBUF,dpl
                                    569 ;	src/main.c:51: SBUF = args;
                                    570 ;	src/main.c:53: }
      000115 22               [24]  571 	ret
                                    572 ;------------------------------------------------------------
                                    573 ;Allocation info for local variables in function 'echo'
                                    574 ;------------------------------------------------------------
                                    575 ;	src/main.c:55: void echo(void){
                                    576 ;	-----------------------------------------
                                    577 ;	 function echo
                                    578 ;	-----------------------------------------
      000116                        579 _echo:
                                    580 ;	src/main.c:56: serial_busy = 1;
      000116 75 38 01         [24]  581 	mov	_serial_busy,#0x01
                                    582 ;	src/main.c:57: while(rd_pointer == wr_pointer);
      000119                        583 00101$:
      000119 E5 33            [12]  584 	mov	a,_wr_pointer
      00011B B5 32 02         [24]  585 	cjne	a,_rd_pointer,00133$
      00011E 80 F9            [24]  586 	sjmp	00101$
      000120                        587 00133$:
                                    588 ;	src/main.c:58: SBUF = *rd_pointer;
      000120 A9 32            [24]  589 	mov	r1,_rd_pointer
      000122 87 99            [24]  590 	mov	_SBUF,@r1
                                    591 ;	src/main.c:59: while(serial_busy);
      000124                        592 00104$:
      000124 E5 38            [12]  593 	mov	a,_serial_busy
      000126 70 FC            [24]  594 	jnz	00104$
                                    595 ;	src/main.c:60: rd_pointer++;
      000128 05 32            [12]  596 	inc	_rd_pointer
                                    597 ;	src/main.c:62: }
      00012A 22               [24]  598 	ret
                                    599 ;------------------------------------------------------------
                                    600 ;Allocation info for local variables in function 'delay_ms_500'
                                    601 ;------------------------------------------------------------
                                    602 ;	src/main.c:68: void delay_ms_500(void){
                                    603 ;	-----------------------------------------
                                    604 ;	 function delay_ms_500
                                    605 ;	-----------------------------------------
      00012B                        606 _delay_ms_500:
                                    607 ;	src/main.c:71: }
      00012B 22               [24]  608 	ret
                                    609 ;------------------------------------------------------------
                                    610 ;Allocation info for local variables in function 'ascii_to_hex'
                                    611 ;------------------------------------------------------------
                                    612 ;	src/main.c:76: void ascii_to_hex(void){
                                    613 ;	-----------------------------------------
                                    614 ;	 function ascii_to_hex
                                    615 ;	-----------------------------------------
      00012C                        616 _ascii_to_hex:
                                    617 ;	src/main.c:79: }
      00012C 22               [24]  618 	ret
                                    619 ;------------------------------------------------------------
                                    620 ;Allocation info for local variables in function 'hex_to_ascii'
                                    621 ;------------------------------------------------------------
                                    622 ;	src/main.c:85: void hex_to_ascii(void){
                                    623 ;	-----------------------------------------
                                    624 ;	 function hex_to_ascii
                                    625 ;	-----------------------------------------
      00012D                        626 _hex_to_ascii:
                                    627 ;	src/main.c:88: }
      00012D 22               [24]  628 	ret
                                    629 ;------------------------------------------------------------
                                    630 ;Allocation info for local variables in function 'print_boot_message'
                                    631 ;------------------------------------------------------------
                                    632 ;	src/main.c:93: void print_boot_message(void){
                                    633 ;	-----------------------------------------
                                    634 ;	 function print_boot_message
                                    635 ;	-----------------------------------------
      00012E                        636 _print_boot_message:
                                    637 ;	src/main.c:95: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      00012E 75 82 44         [24]  638 	mov	dpl, #0x44
      000131 12 01 12         [24]  639 	lcall	_put_char
      000134 75 82 65         [24]  640 	mov	dpl, #0x65
      000137 12 01 12         [24]  641 	lcall	_put_char
      00013A 75 82 62         [24]  642 	mov	dpl, #0x62
      00013D 12 01 12         [24]  643 	lcall	_put_char
      000140 75 82 75         [24]  644 	mov	dpl, #0x75
      000143 12 01 12         [24]  645 	lcall	_put_char
      000146 75 82 67         [24]  646 	mov	dpl, #0x67
      000149 12 01 12         [24]  647 	lcall	_put_char
      00014C 75 82 0A         [24]  648 	mov	dpl, #0x0a
                                    649 ;	src/main.c:97: }
      00014F 02 01 12         [24]  650 	ljmp	_put_char
                                    651 ;------------------------------------------------------------
                                    652 ;Allocation info for local variables in function 'Serial_ISR'
                                    653 ;------------------------------------------------------------
                                    654 ;	src/main.c:105: void Serial_ISR(void) __interrupt (4)
                                    655 ;	-----------------------------------------
                                    656 ;	 function Serial_ISR
                                    657 ;	-----------------------------------------
      000152                        658 _Serial_ISR:
      000152 C0 E0            [24]  659 	push	acc
      000154 C0 00            [24]  660 	push	ar0
      000156 C0 D0            [24]  661 	push	psw
      000158 75 D0 00         [24]  662 	mov	psw,#0x00
                                    663 ;	src/main.c:107: if(RI){						//Recieve Interrput == RI
      00015B 30 98 09         [24]  664 	jnb	_RI,00102$
                                    665 ;	src/main.c:108: *wr_pointer = SBUF;		//Store Input Data in Buffer
      00015E E5 33            [12]  666 	mov	a,_wr_pointer
      000160 F8               [12]  667 	mov	r0,a
      000161 A6 99            [24]  668 	mov	@r0,_SBUF
                                    669 ;	src/main.c:109: wr_pointer++;
      000163 05 33            [12]  670 	inc	_wr_pointer
                                    671 ;	src/main.c:110: RI = 0;
                                    672 ;	assignBit
      000165 C2 98            [12]  673 	clr	_RI
      000167                        674 00102$:
                                    675 ;	src/main.c:113: if(TI){
                                    676 ;	src/main.c:114: TI = 0;
                                    677 ;	assignBit
      000167 10 99 02         [24]  678 	jbc	_TI,00120$
      00016A 80 03            [24]  679 	sjmp	00105$
      00016C                        680 00120$:
                                    681 ;	src/main.c:115: serial_busy = 0;		//serial_busy flag;
      00016C 75 38 00         [24]  682 	mov	_serial_busy,#0x00
      00016F                        683 00105$:
                                    684 ;	src/main.c:119: }
      00016F D0 D0            [24]  685 	pop	psw
      000171 D0 00            [24]  686 	pop	ar0
      000173 D0 E0            [24]  687 	pop	acc
      000175 32               [24]  688 	reti
                                    689 ;	eliminated unneeded push/pop ar1
                                    690 ;	eliminated unneeded push/pop dpl
                                    691 ;	eliminated unneeded push/pop dph
                                    692 ;	eliminated unneeded push/pop b
                                    693 ;------------------------------------------------------------
                                    694 ;Allocation info for local variables in function 'main'
                                    695 ;------------------------------------------------------------
                                    696 ;	src/main.c:121: void main(void){
                                    697 ;	-----------------------------------------
                                    698 ;	 function main
                                    699 ;	-----------------------------------------
      000176                        700 _main:
                                    701 ;	src/main.c:124: init_serial();
      000176 12 00 FF         [24]  702 	lcall	_init_serial
                                    703 ;	src/main.c:125: while(1){
      000179                        704 00102$:
                                    705 ;	src/main.c:126: put_char('A');
      000179 75 82 41         [24]  706 	mov	dpl, #0x41
      00017C 12 01 12         [24]  707 	lcall	_put_char
                                    708 ;	src/main.c:128: }
      00017F 80 F8            [24]  709 	sjmp	00102$
                                    710 	.area CSEG    (CODE)
                                    711 	.area CONST   (CODE)
                                    712 	.area XINIT   (CODE)
