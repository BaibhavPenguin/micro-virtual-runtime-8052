...
;------------------------------------------------------------
;	src/main.c:45: void put_char(char dat){
;	-----------------------------------------
;	 function put_char
;	-----------------------------------------
_put_char:
	mov	_SBUF,dpl
;	src/main.c:47: while(!TI);
00101$:
;	src/main.c:48: TI = 0;
;	assignBit
	jbc	_TI,00118$
...
;	-----------------------------------------
_print_boot_message:
;	src/main.c:87: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
	mov	dpl, #0x44
	lcall	_put_char
	mov	dpl, #0x65
	lcall	_put_char
...
;	-----------------------------------------
_main:
;	src/main.c:98: init_mpu();
	lcall	_init_mpu
;	src/main.c:99: init_serial();
	lcall	_init_serial
;	src/main.c:101: while(1){
00102$:
;	src/main.c:102: put_char('A');
	mov	dpl, #0x41
	lcall	_put_char
;	src/main.c:104: }
	sjmp	00102$
