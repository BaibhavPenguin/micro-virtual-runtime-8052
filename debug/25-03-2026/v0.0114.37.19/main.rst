      ...
      00010A 75 38 00         [24]  549 	mov	_serial_busy,#0x00
                                    550 ;	src/main.c:44: TI = 0;
                                    551 ;	assignBit
      00010D C2 99            [12]  552 	clr	_TI
                                    553 ;	src/main.c:45: RI = 0;
                                    554 ;	assignBit
      00010F C2 98            [12]  555 	clr	_RI
                                    556 ;	src/main.c:46: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
      000111 75 98 50         [24]  557 	mov	_SCON,#0x50
                                    558 ;	src/main.c:47: ES = 1;						//Enable Serial interrupt
                                    559 ;	assignBit
      000114 D2 AC            [12]  560 	setb	_ES
                                    561 ;	src/main.c:49: }
      000116 22               [24]  562 	ret
                                    563 ;------------------------------------------------------------
                                    564 ;Allocation info for local variables in function 'put_char'
                                    565 ;------------------------------------------------------------
                                    566 ;args          Allocated to registers r7 
                                    567 ;------------------------------------------------------------
                                    568 ;	src/main.c:52: void put_char(char args){
                                    569 ;	-----------------------------------------
                                    570 ;	 function put_char
                                    571 ;	-----------------------------------------
      000117                        572 _put_char:
      000117 AF 82            [24]  573 	mov	r7, dpl
                                    574 ;	src/main.c:53: while(serial_busy != 0x00);
      000119                        575 00101$:
      000119 E5 38            [12]  576 	mov	a,_serial_busy
      00011B 70 FC            [24]  577 	jnz	00101$
                                    578 ;	src/main.c:54: serial_busy = 0x01;
      00011D 75 38 01         [24]  579 	mov	_serial_busy,#0x01
                                    580 ;	src/main.c:55: SBUF = args;
      ...
      000137 22               [24]  610 	ret
                                    ...
                                    613 ;------------------------------------------------------------
                                    614 ;	src/main.c:73: void delay_ms_500(void){
                                    615 ;	-----------------------------------------
      ...
      000138 22               [24]  620 	ret
                                    ...
                                    623 ;------------------------------------------------------------
                                    624 ;	src/main.c:81: void ascii_to_hex(void){
                                    625 ;	-----------------------------------------
      ...
      000139 22               [24]  630 	ret
                                    ...
                                    633 ;------------------------------------------------------------
                                    634 ;	src/main.c:90: void hex_to_ascii(void){
                                    635 ;	-----------------------------------------
      ...
      00013A 22               [24]  640 	ret
                                    ...
                                    643 ;------------------------------------------------------------
                                    644 ;	src/main.c:98: void print_boot_message(void){
                                    645 ;	-----------------------------------------
                                    646 ;	 function print_boot_message
                                    647 ;	-----------------------------------------
      00013B                        648 _print_boot_message:
                                    649 ;	src/main.c:100: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      ...
      00015C 02 01 17         [24]  662 	ljmp	_put_char
                                    ...
                                    665 ;------------------------------------------------------------
                                    666 ;	src/main.c:110: void Serial_ISR(void) __interrupt (4)
                                    667 ;	-----------------------------------------
      ...
      000165 75 D0 00         [24]  674 	mov	psw,#0x00
                                    675 ;	src/main.c:112: if(RI){						//Recieve Interrput == RI
      000168 30 98 09         [24]  676 	jnb	_RI,00102$
                                    677 ;	src/main.c:113: *wr_pointer = SBUF;		//Store Input Data in Buffer
      00016B E5 33            [12]  678 	mov	a,_wr_pointer
      00016D F8               [12]  679 	mov	r0,a
      00016E A6 99            [24]  680 	mov	@r0,_SBUF
                                    681 ;	src/main.c:114: wr_pointer++;
      000170 05 33            [12]  682 	inc	_wr_pointer
                                    683 ;	src/main.c:115: RI = 0;
                                    684 ;	assignBit
      000172 C2 98            [12]  685 	clr	_RI
      000174                        686 00102$:
                                    687 ;	src/main.c:118: if(TI){
                                    688 ;	src/main.c:119: TI = 0;
                                    689 ;	assignBit
      ...
      000186 12 00 FF         [24]  716 	lcall	_init_serial
                                    717 ;	src/main.c:128: while(1){
      000189                        718 00102$:
                                    719 ;	src/main.c:129: put_char('A');
      000189 75 82 41         [24]  720 	mov	dpl, #0x41
      00018C 12 01 17         [24]  721 	lcall	_put_char
                                    722 ;	src/main.c:131: }
      00018F 80 F8            [24]  723 	sjmp	00102$
                                    724 	.area CSEG    (CODE)
                                    725 	.area CONST   (CODE)
                                    726 	.area XINIT   (CODE)
