      ...
      000040                        332 	.ds 32
                                    ...
                                    336 ;--------------------------------------------------------
                                    337 	.area BSEG    (BIT)
                           000000   338 _serial_busy	=	0x0000
                                    339 ;--------------------------------------------------------
      ...
      00001C                        378 	.ds	7
      000023 02 01 48         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 6B         [24]  461 	ljmp	_main
      ...
      0000CB                        474 _init_mpu:
                           ...
                           000001   481 	ar1 = 0x01
                           000000   482 	ar0 = 0x00
                                    483 ;	src/main.c:7: EA = 1;
                                    484 ;	assignBit
      0000CB D2 AF            [12]  485 	setb	_EA
                                    486 ;	src/main.c:8: ES = 1;
                                    487 ;	assignBit
      0000CD D2 AC            [12]  488 	setb	_ES
                                    489 ;	src/main.c:9: IP = 0x10;
      0000CF 75 B8 10         [24]  490 	mov	_IP,#0x10
                                    491 ;	src/main.c:10: SP = hw_stack;		//Initialize Stack Pointer
      0000D2 75 81 60         [24]  492 	mov	_SP,#0x60
                                    493 ;	src/main.c:14: loop_counter = 00;
      0000D5 75 30 00         [24]  494 	mov	_loop_counter,#0x00
                                    495 ;	src/main.c:15: prog_counter = 00;
      0000D8 75 31 00         [24]  496 	mov	_prog_counter,#0x00
                                    497 ;	src/main.c:16: rd_pointer = 0x40;	//Read Memory
      0000DB 75 32 40         [24]  498 	mov	_rd_pointer,#0x40
                                    499 ;	src/main.c:17: wr_pointer = 0x40;		//Write Memory
      0000DE 75 33 40         [24]  500 	mov	_wr_pointer,#0x40
                                    501 ;	src/main.c:18: system_tick = 00;
      0000E1 75 34 00         [24]  502 	mov	_system_tick,#0x00
                                    503 ;	src/main.c:19: op1 = 00;
      0000E4 75 35 00         [24]  504 	mov	_op1,#0x00
                                    505 ;	src/main.c:20: op2 = 00;
      0000E7 75 36 00         [24]  506 	mov	_op2,#0x00
                                    507 ;	src/main.c:21: active_timer = 00;
      0000EA 75 37 00         [24]  508 	mov	_active_timer,#0x00
                                    509 ;	src/main.c:22: serial_busy = 00;
                                    510 ;	assignBit
      0000ED C2 00            [12]  511 	clr	_serial_busy
                                    512 ;	src/main.c:23: temp1 = 00;
      0000EF 75 39 00         [24]  513 	mov	_temp1,#0x00
                                    514 ;	src/main.c:24: temp2 = 00;
      0000F2 75 3A 00         [24]  515 	mov	_temp2,#0x00
                                    516 ;	src/main.c:25: temp3 = 00;
      0000F5 75 3C 00         [24]  517 	mov	_temp3,#0x00
                                    518 ;	src/main.c:26: instruction_buffer = 00;
      0000F8 75 3D 00         [24]  519 	mov	_instruction_buffer,#0x00
                                    520 ;	src/main.c:27: result_l = 00;
      0000FB 75 3E 00         [24]  521 	mov	_result_l,#0x00
                                    522 ;	src/main.c:28: result_h = 00;
      0000FE 75 3F 00         [24]  523 	mov	_result_h,#0x00
                                    524 ;	src/main.c:29: }
      000101 22               [24]  525 	ret
                                    526 ;------------------------------------------------------------
                                    527 ;Allocation info for local variables in function 'init_timer'
                                    528 ;------------------------------------------------------------
                                    529 ;	src/main.c:33: void init_timer(void){
                                    530 ;	-----------------------------------------
                                    531 ;	 function init_timer
                                    532 ;	-----------------------------------------
      000102                        533 _init_timer:
                                    534 ;	src/main.c:35: }
      000102 22               [24]  535 	ret
                                    536 ;------------------------------------------------------------
                                    537 ;Allocation info for local variables in function 'init_serial'
                                    538 ;------------------------------------------------------------
                                    539 ;	src/main.c:38: void init_serial(void){
                                    540 ;	-----------------------------------------
                                    541 ;	 function init_serial
                                    542 ;	-----------------------------------------
      000103                        543 _init_serial:
                                    544 ;	src/main.c:40: TMOD = 0x20;				//Set TMOD to Use Timer 1 in 8 Bit Auto Reload
      000103 75 89 20         [24]  545 	mov	_TMOD,#0x20
                                    546 ;	src/main.c:41: TH1 = serial_baud_timer;	//Set Reload value
      000106 75 8D FD         [24]  547 	mov	_TH1,#0xfd
                                    548 ;	src/main.c:42: TL1 = serial_baud_timer;	//Set Initial Value
      000109 75 8B FD         [24]  549 	mov	_TL1,#0xfd
                                    550 ;	src/main.c:43: TR1 = 1;					//Start Timer 1
                                    551 ;	assignBit
      00010C D2 8E            [12]  552 	setb	_TR1
                                    553 ;	src/main.c:44: TI = 0;
                                    554 ;	assignBit
      00010E C2 99            [12]  555 	clr	_TI
                                    556 ;	src/main.c:45: RI = 0;
                                    557 ;	assignBit
      000110 C2 98            [12]  558 	clr	_RI
                                    559 ;	src/main.c:46: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
      000112 75 98 50         [24]  560 	mov	_SCON,#0x50
                                    561 ;	src/main.c:48: }
      000115 22               [24]  562 	ret
                                    563 ;------------------------------------------------------------
                                    564 ;Allocation info for local variables in function 'put_char'
                                    565 ;------------------------------------------------------------
                                    566 ;args          Allocated to registers r7 
                                    567 ;------------------------------------------------------------
                                    568 ;	src/main.c:51: void put_char(char args){
                                    569 ;	-----------------------------------------
                                    570 ;	 function put_char
                                    571 ;	-----------------------------------------
      000116                        572 _put_char:
      000116 AF 82            [24]  573 	mov	r7, dpl
                                    574 ;	src/main.c:52: while(serial_busy);
      000118                        575 00101$:
      000118 20 00 FD         [24]  576 	jb	_serial_busy,00101$
                                    577 ;	src/main.c:53: serial_busy = 1;
                                    578 ;	assignBit
      00011B D2 00            [12]  579 	setb	_serial_busy
                                    580 ;	src/main.c:54: SBUF = args;
      00011D 8F 99            [24]  581 	mov	_SBUF,r7
                                    582 ;	src/main.c:56: }
      00011F 22               [24]  583 	ret
                                    584 ;------------------------------------------------------------
                                    585 ;Allocation info for local variables in function 'echo'
                                    586 ;------------------------------------------------------------
                                    587 ;	src/main.c:58: void echo(void){
                                    588 ;	-----------------------------------------
                                    589 ;	 function echo
                                    590 ;	-----------------------------------------
      000120                        591 _echo:
                                    592 ;	src/main.c:60: }
      000120 22               [24]  593 	ret
                                    594 ;------------------------------------------------------------
                                    595 ;Allocation info for local variables in function 'delay_ms_500'
                                    596 ;------------------------------------------------------------
                                    597 ;	src/main.c:66: void delay_ms_500(void){
                                    598 ;	-----------------------------------------
                                    599 ;	 function delay_ms_500
                                    600 ;	-----------------------------------------
      000121                        601 _delay_ms_500:
                                    602 ;	src/main.c:69: }
      000121 22               [24]  603 	ret
                                    604 ;------------------------------------------------------------
                                    605 ;Allocation info for local variables in function 'ascii_to_hex'
                                    606 ;------------------------------------------------------------
                                    607 ;	src/main.c:74: void ascii_to_hex(void){
                                    608 ;	-----------------------------------------
                                    609 ;	 function ascii_to_hex
                                    610 ;	-----------------------------------------
      000122                        611 _ascii_to_hex:
                                    612 ;	src/main.c:77: }
      000122 22               [24]  613 	ret
                                    614 ;------------------------------------------------------------
                                    615 ;Allocation info for local variables in function 'hex_to_ascii'
                                    616 ;------------------------------------------------------------
                                    617 ;	src/main.c:83: void hex_to_ascii(void){
                                    618 ;	-----------------------------------------
                                    619 ;	 function hex_to_ascii
                                    620 ;	-----------------------------------------
      000123                        621 _hex_to_ascii:
                                    622 ;	src/main.c:86: }
      000123 22               [24]  623 	ret
                                    624 ;------------------------------------------------------------
                                    625 ;Allocation info for local variables in function 'print_boot_message'
                                    626 ;------------------------------------------------------------
                                    627 ;	src/main.c:91: void print_boot_message(void){
                                    628 ;	-----------------------------------------
                                    629 ;	 function print_boot_message
                                    630 ;	-----------------------------------------
      000124                        631 _print_boot_message:
                                    632 ;	src/main.c:93: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000124 75 82 44         [24]  633 	mov	dpl, #0x44
      000127 12 01 16         [24]  634 	lcall	_put_char
      00012A 75 82 65         [24]  635 	mov	dpl, #0x65
      00012D 12 01 16         [24]  636 	lcall	_put_char
      000130 75 82 62         [24]  637 	mov	dpl, #0x62
      000133 12 01 16         [24]  638 	lcall	_put_char
      000136 75 82 75         [24]  639 	mov	dpl, #0x75
      000139 12 01 16         [24]  640 	lcall	_put_char
      00013C 75 82 67         [24]  641 	mov	dpl, #0x67
      00013F 12 01 16         [24]  642 	lcall	_put_char
      000142 75 82 0A         [24]  643 	mov	dpl, #0x0a
                                    644 ;	src/main.c:95: }
      000145 02 01 16         [24]  645 	ljmp	_put_char
                                    646 ;------------------------------------------------------------
                                    647 ;Allocation info for local variables in function 'Serial_ISR'
                                    648 ;------------------------------------------------------------
                                    649 ;	src/main.c:103: void Serial_ISR(void) __interrupt (4)
                                    650 ;	-----------------------------------------
                                    651 ;	 function Serial_ISR
                                    652 ;	-----------------------------------------
      000148                        653 _Serial_ISR:
      000148 C0 E0            [24]  654 	push	acc
      00014A C0 00            [24]  655 	push	ar0
      00014C C0 D0            [24]  656 	push	psw
      00014E 75 D0 00         [24]  657 	mov	psw,#0x00
                                    658 ;	src/main.c:105: if(RI){						//Recieve Interrput == RI
      000151 30 98 09         [24]  659 	jnb	_RI,00102$
                                    660 ;	src/main.c:106: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000154 E5 33            [12]  661 	mov	a,_wr_pointer
      000156 F8               [12]  662 	mov	r0,a
      000157 A6 99            [24]  663 	mov	@r0,_SBUF
                                    664 ;	src/main.c:107: wr_pointer++;
      000159 05 33            [12]  665 	inc	_wr_pointer
                                    666 ;	src/main.c:108: RI = 0;
                                    667 ;	assignBit
      00015B C2 98            [12]  668 	clr	_RI
      00015D                        669 00102$:
                                    670 ;	src/main.c:111: if(TI){
                                    671 ;	src/main.c:113: TI = 0;
                                    672 ;	assignBit
      00015D 10 99 02         [24]  673 	jbc	_TI,00120$
      000160 80 02            [24]  674 	sjmp	00105$
      000162                        675 00120$:
                                    676 ;	src/main.c:114: serial_busy = 0;
                                    677 ;	assignBit
      000162 C2 00            [12]  678 	clr	_serial_busy
      000164                        679 00105$:
                                    680 ;	src/main.c:116: }
      000164 D0 D0            [24]  681 	pop	psw
      000166 D0 00            [24]  682 	pop	ar0
      000168 D0 E0            [24]  683 	pop	acc
      00016A 32               [24]  684 	reti
                                    685 ;	eliminated unneeded push/pop ar1
                                    ...
                                    691 ;------------------------------------------------------------
                                    692 ;	src/main.c:118: void main(void){
                                    693 ;	-----------------------------------------
                                    694 ;	 function main
                                    695 ;	-----------------------------------------
      00016B                        696 _main:
                                    697 ;	src/main.c:119: init_serial();
      00016B 12 01 03         [24]  698 	lcall	_init_serial
                                    699 ;	src/main.c:120: init_mpu();
      00016E 12 00 CB         [24]  700 	lcall	_init_mpu
                                    701 ;	src/main.c:122: while(1){
      000171                        702 00102$:
                                    703 ;	src/main.c:123: put_char('A');
      000171 75 82 41         [24]  704 	mov	dpl, #0x41
      000174 12 01 16         [24]  705 	lcall	_put_char
                                    706 ;	src/main.c:126: }
      000177 80 F8            [24]  707 	sjmp	00102$
                                    708 	.area CSEG    (CODE)
                                    709 	.area CONST   (CODE)
                                    710 	.area XINIT   (CODE)
