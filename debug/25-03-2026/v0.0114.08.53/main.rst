      ...
      00001C                        378 	.ds	7
      000023 02 01 53         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 77         [24]  461 	ljmp	_main
      ...
      00010F 22               [24]  554 	ret
                                    ...
                                    557 ;------------------------------------------------------------
                                    558 ;args          Allocated to registers 
                                    559 ;------------------------------------------------------------
      ...
      000110 85 82 99         [24]  565 	mov	_SBUF,dpl
                                    566 ;	src/main.c:52: while(!TI);
      000113                        567 00101$:
      000113 30 99 FD         [24]  568 	jnb	_TI,00101$
                                    569 ;	src/main.c:54: }
      000116 22               [24]  570 	ret
                                    571 ;------------------------------------------------------------
                                    572 ;Allocation info for local variables in function 'echo'
                                    573 ;------------------------------------------------------------
                                    574 ;	src/main.c:56: void echo(void){
                                    575 ;	-----------------------------------------
                                    576 ;	 function echo
                                    577 ;	-----------------------------------------
      000117                        578 _echo:
                                    579 ;	src/main.c:57: serial_busy = 1;
      000117 75 38 01         [24]  580 	mov	_serial_busy,#0x01
                                    581 ;	src/main.c:58: while(rd_pointer == wr_pointer);
      00011A                        582 00101$:
      00011A E5 33            [12]  583 	mov	a,_wr_pointer
      00011C B5 32 02         [24]  584 	cjne	a,_rd_pointer,00133$
      00011F 80 F9            [24]  585 	sjmp	00101$
      000121                        586 00133$:
                                    587 ;	src/main.c:59: SBUF = *rd_pointer;
      000121 A9 32            [24]  588 	mov	r1,_rd_pointer
      000123 87 99            [24]  589 	mov	_SBUF,@r1
                                    590 ;	src/main.c:60: while(serial_busy);
      000125                        591 00104$:
      000125 E5 38            [12]  592 	mov	a,_serial_busy
      000127 70 FC            [24]  593 	jnz	00104$
                                    594 ;	src/main.c:61: rd_pointer++;
      000129 05 32            [12]  595 	inc	_rd_pointer
                                    596 ;	src/main.c:63: }
      00012B 22               [24]  597 	ret
                                    598 ;------------------------------------------------------------
                                    599 ;Allocation info for local variables in function 'delay_ms_500'
                                    600 ;------------------------------------------------------------
                                    601 ;	src/main.c:69: void delay_ms_500(void){
                                    602 ;	-----------------------------------------
                                    603 ;	 function delay_ms_500
                                    604 ;	-----------------------------------------
      00012C                        605 _delay_ms_500:
                                    606 ;	src/main.c:72: }
      00012C 22               [24]  607 	ret
                                    608 ;------------------------------------------------------------
                                    609 ;Allocation info for local variables in function 'ascii_to_hex'
                                    610 ;------------------------------------------------------------
                                    611 ;	src/main.c:77: void ascii_to_hex(void){
                                    612 ;	-----------------------------------------
                                    613 ;	 function ascii_to_hex
                                    614 ;	-----------------------------------------
      00012D                        615 _ascii_to_hex:
                                    616 ;	src/main.c:80: }
      00012D 22               [24]  617 	ret
                                    618 ;------------------------------------------------------------
                                    619 ;Allocation info for local variables in function 'hex_to_ascii'
                                    620 ;------------------------------------------------------------
                                    621 ;	src/main.c:86: void hex_to_ascii(void){
                                    622 ;	-----------------------------------------
                                    623 ;	 function hex_to_ascii
                                    624 ;	-----------------------------------------
      00012E                        625 _hex_to_ascii:
                                    626 ;	src/main.c:89: }
      00012E 22               [24]  627 	ret
                                    628 ;------------------------------------------------------------
                                    629 ;Allocation info for local variables in function 'print_boot_message'
                                    630 ;------------------------------------------------------------
                                    631 ;	src/main.c:94: void print_boot_message(void){
                                    632 ;	-----------------------------------------
                                    633 ;	 function print_boot_message
                                    634 ;	-----------------------------------------
      00012F                        635 _print_boot_message:
                                    636 ;	src/main.c:96: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      00012F 75 82 44         [24]  637 	mov	dpl, #0x44
      000132 12 01 10         [24]  638 	lcall	_put_char
      000135 75 82 65         [24]  639 	mov	dpl, #0x65
      000138 12 01 10         [24]  640 	lcall	_put_char
      00013B 75 82 62         [24]  641 	mov	dpl, #0x62
      00013E 12 01 10         [24]  642 	lcall	_put_char
      000141 75 82 75         [24]  643 	mov	dpl, #0x75
      000144 12 01 10         [24]  644 	lcall	_put_char
      000147 75 82 67         [24]  645 	mov	dpl, #0x67
      00014A 12 01 10         [24]  646 	lcall	_put_char
      00014D 75 82 0A         [24]  647 	mov	dpl, #0x0a
                                    648 ;	src/main.c:98: }
      000150 02 01 10         [24]  649 	ljmp	_put_char
                                    650 ;------------------------------------------------------------
                                    651 ;Allocation info for local variables in function 'Serial_ISR'
                                    652 ;------------------------------------------------------------
                                    653 ;	src/main.c:106: void Serial_ISR(void) __interrupt (4)
                                    654 ;	-----------------------------------------
                                    655 ;	 function Serial_ISR
                                    656 ;	-----------------------------------------
      000153                        657 _Serial_ISR:
      000153 C0 E0            [24]  658 	push	acc
      000155 C0 00            [24]  659 	push	ar0
      000157 C0 D0            [24]  660 	push	psw
      000159 75 D0 00         [24]  661 	mov	psw,#0x00
                                    662 ;	src/main.c:108: if(RI){						//Recieve Interrput == RI
      00015C 30 98 09         [24]  663 	jnb	_RI,00102$
                                    664 ;	src/main.c:109: *wr_pointer = SBUF;		//Store Input Data in Buffer
      00015F E5 33            [12]  665 	mov	a,_wr_pointer
      000161 F8               [12]  666 	mov	r0,a
      000162 A6 99            [24]  667 	mov	@r0,_SBUF
                                    668 ;	src/main.c:110: wr_pointer++;
      000164 05 33            [12]  669 	inc	_wr_pointer
                                    670 ;	src/main.c:111: RI = 0;
                                    671 ;	assignBit
      000166 C2 98            [12]  672 	clr	_RI
      000168                        673 00102$:
                                    674 ;	src/main.c:114: if(TI){
                                    675 ;	src/main.c:115: TI = 0;
                                    676 ;	assignBit
      000168 10 99 02         [24]  677 	jbc	_TI,00120$
      00016B 80 03            [24]  678 	sjmp	00105$
      00016D                        679 00120$:
                                    680 ;	src/main.c:116: serial_busy = 0;		//serial_busy flag;
      00016D 75 38 00         [24]  681 	mov	_serial_busy,#0x00
      000170                        682 00105$:
                                    683 ;	src/main.c:120: }
      000170 D0 D0            [24]  684 	pop	psw
      000172 D0 00            [24]  685 	pop	ar0
      000174 D0 E0            [24]  686 	pop	acc
      000176 32               [24]  687 	reti
                                    688 ;	eliminated unneeded push/pop ar1
                                    ...
                                    694 ;------------------------------------------------------------
                                    695 ;	src/main.c:122: void main(void){
                                    696 ;	-----------------------------------------
                                    697 ;	 function main
                                    698 ;	-----------------------------------------
      000177                        699 _main:
                                    700 ;	src/main.c:123: init_mpu();
      000177 12 00 CB         [24]  701 	lcall	_init_mpu
                                    702 ;	src/main.c:125: init_serial();
      00017A 12 00 FF         [24]  703 	lcall	_init_serial
                                    704 ;	src/main.c:126: while(1){
      00017D                        705 00102$:
                                    706 ;	src/main.c:127: put_char('A');
      00017D 75 82 41         [24]  707 	mov	dpl, #0x41
      000180 12 01 10         [24]  708 	lcall	_put_char
                                    709 ;	src/main.c:129: }
      000183 80 F8            [24]  710 	sjmp	00102$
                                    711 	.area CSEG    (CODE)
                                    712 	.area CONST   (CODE)
                                    713 	.area XINIT   (CODE)
