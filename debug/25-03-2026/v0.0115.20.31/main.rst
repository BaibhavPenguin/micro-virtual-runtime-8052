      ...
      00001C                        378 	.ds	7
      000023 02 01 5E         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 85         [24]  461 	ljmp	_main
      ...
      000108 D2 8E            [12]  546 	setb	_TR1
                                    547 ;	src/main.c:42: TI = 0;
                                    548 ;	assignBit
      00010A C2 99            [12]  549 	clr	_TI
                                    550 ;	src/main.c:43: RI = 0;
                                    551 ;	assignBit
      00010C C2 98            [12]  552 	clr	_RI
                                    553 ;	src/main.c:44: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
      00010E 75 98 50         [24]  554 	mov	_SCON,#0x50
                                    555 ;	src/main.c:45: ES = 1;						//Enable Serial interrupt
                                    556 ;	assignBit
      000111 D2 AC            [12]  557 	setb	_ES
                                    558 ;	src/main.c:47: }
      000113 22               [24]  559 	ret
                                    560 ;------------------------------------------------------------
                                    561 ;Allocation info for local variables in function 'put_char'
                                    562 ;------------------------------------------------------------
                                    563 ;args          Allocated to registers r7 
                                    564 ;------------------------------------------------------------
                                    565 ;	src/main.c:50: void put_char(char args){
                                    566 ;	-----------------------------------------
                                    567 ;	 function put_char
                                    568 ;	-----------------------------------------
      000114                        569 _put_char:
      000114 AF 82            [24]  570 	mov	r7, dpl
                                    571 ;	src/main.c:52: while(serial_busy != 0);
      000116                        572 00101$:
      000116 E5 38            [12]  573 	mov	a,_serial_busy
                                    574 ;	src/main.c:53: serial_busy = 0x01;
                                    575 ;	src/main.c:54: P1 = 0x00;
      000118 70 FC            [24]  576 	jnz	00101$
      00011A 75 38 01         [24]  577 	mov	_serial_busy,#0x01
      00011D F5 90            [12]  578 	mov	_P1,a
                                    579 ;	src/main.c:55: SBUF = args;
      00011F 8F 99            [24]  580 	mov	_SBUF,r7
                                    581 ;	src/main.c:57: }
      000121 22               [24]  582 	ret
                                    583 ;------------------------------------------------------------
                                    584 ;Allocation info for local variables in function 'echo'
                                    585 ;------------------------------------------------------------
                                    586 ;	src/main.c:59: void echo(void){
                                    587 ;	-----------------------------------------
                                    588 ;	 function echo
                                    589 ;	-----------------------------------------
      000122                        590 _echo:
                                    591 ;	src/main.c:60: serial_busy = 1;
      000122 75 38 01         [24]  592 	mov	_serial_busy,#0x01
                                    593 ;	src/main.c:61: while(rd_pointer == wr_pointer);
      000125                        594 00101$:
      000125 E5 33            [12]  595 	mov	a,_wr_pointer
      000127 B5 32 02         [24]  596 	cjne	a,_rd_pointer,00133$
      00012A 80 F9            [24]  597 	sjmp	00101$
      00012C                        598 00133$:
                                    599 ;	src/main.c:62: SBUF = *rd_pointer;
      00012C A9 32            [24]  600 	mov	r1,_rd_pointer
      00012E 87 99            [24]  601 	mov	_SBUF,@r1
                                    602 ;	src/main.c:63: while(serial_busy);
      000130                        603 00104$:
      000130 E5 38            [12]  604 	mov	a,_serial_busy
      000132 70 FC            [24]  605 	jnz	00104$
                                    606 ;	src/main.c:64: rd_pointer++;
      000134 05 32            [12]  607 	inc	_rd_pointer
                                    608 ;	src/main.c:66: }
      000136 22               [24]  609 	ret
                                    610 ;------------------------------------------------------------
                                    611 ;Allocation info for local variables in function 'delay_ms_500'
                                    612 ;------------------------------------------------------------
                                    613 ;	src/main.c:72: void delay_ms_500(void){
                                    614 ;	-----------------------------------------
                                    615 ;	 function delay_ms_500
                                    616 ;	-----------------------------------------
      000137                        617 _delay_ms_500:
                                    618 ;	src/main.c:75: }
      000137 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    621 ;Allocation info for local variables in function 'ascii_to_hex'
                                    622 ;------------------------------------------------------------
                                    623 ;	src/main.c:80: void ascii_to_hex(void){
                                    624 ;	-----------------------------------------
                                    625 ;	 function ascii_to_hex
                                    626 ;	-----------------------------------------
      000138                        627 _ascii_to_hex:
                                    628 ;	src/main.c:83: }
      000138 22               [24]  629 	ret
                                    630 ;------------------------------------------------------------
                                    631 ;Allocation info for local variables in function 'hex_to_ascii'
                                    632 ;------------------------------------------------------------
                                    633 ;	src/main.c:89: void hex_to_ascii(void){
                                    634 ;	-----------------------------------------
                                    635 ;	 function hex_to_ascii
                                    636 ;	-----------------------------------------
      000139                        637 _hex_to_ascii:
                                    638 ;	src/main.c:92: }
      000139 22               [24]  639 	ret
                                    640 ;------------------------------------------------------------
                                    641 ;Allocation info for local variables in function 'print_boot_message'
                                    642 ;------------------------------------------------------------
                                    643 ;	src/main.c:97: void print_boot_message(void){
                                    644 ;	-----------------------------------------
                                    645 ;	 function print_boot_message
                                    646 ;	-----------------------------------------
      00013A                        647 _print_boot_message:
                                    648 ;	src/main.c:99: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      00013A 75 82 44         [24]  649 	mov	dpl, #0x44
      00013D 12 01 14         [24]  650 	lcall	_put_char
      000140 75 82 65         [24]  651 	mov	dpl, #0x65
      000143 12 01 14         [24]  652 	lcall	_put_char
      000146 75 82 62         [24]  653 	mov	dpl, #0x62
      000149 12 01 14         [24]  654 	lcall	_put_char
      00014C 75 82 75         [24]  655 	mov	dpl, #0x75
      00014F 12 01 14         [24]  656 	lcall	_put_char
      000152 75 82 67         [24]  657 	mov	dpl, #0x67
      000155 12 01 14         [24]  658 	lcall	_put_char
      000158 75 82 0A         [24]  659 	mov	dpl, #0x0a
                                    660 ;	src/main.c:101: }
      00015B 02 01 14         [24]  661 	ljmp	_put_char
                                    662 ;------------------------------------------------------------
                                    663 ;Allocation info for local variables in function 'Serial_ISR'
                                    664 ;------------------------------------------------------------
                                    665 ;	src/main.c:109: void Serial_ISR(void) __interrupt (4)
                                    666 ;	-----------------------------------------
                                    667 ;	 function Serial_ISR
                                    668 ;	-----------------------------------------
      00015E                        669 _Serial_ISR:
      00015E C0 E0            [24]  670 	push	acc
      000160 C0 00            [24]  671 	push	ar0
      000162 C0 D0            [24]  672 	push	psw
      000164 75 D0 00         [24]  673 	mov	psw,#0x00
                                    674 ;	src/main.c:111: if(RI){						//Recieve Interrput == RI
      000167 30 98 09         [24]  675 	jnb	_RI,00102$
                                    676 ;	src/main.c:112: *wr_pointer = SBUF;		//Store Input Data in Buffer
      00016A E5 33            [12]  677 	mov	a,_wr_pointer
      00016C F8               [12]  678 	mov	r0,a
      00016D A6 99            [24]  679 	mov	@r0,_SBUF
                                    680 ;	src/main.c:113: wr_pointer++;
      00016F 05 33            [12]  681 	inc	_wr_pointer
                                    682 ;	src/main.c:114: RI = 0;
                                    683 ;	assignBit
      000171 C2 98            [12]  684 	clr	_RI
      000173                        685 00102$:
                                    686 ;	src/main.c:117: if(TI){
      000173 30 99 08         [24]  687 	jnb	_TI,00105$
                                    688 ;	src/main.c:118: P1 = 0x01;			//Temp
      000176 75 90 01         [24]  689 	mov	_P1,#0x01
                                    690 ;	src/main.c:119: TI = 0;
                                    691 ;	assignBit
      000179 C2 99            [12]  692 	clr	_TI
                                    693 ;	src/main.c:120: serial_busy = 0;
      00017B 75 38 00         [24]  694 	mov	_serial_busy,#0x00
      00017E                        695 00105$:
                                    696 ;	src/main.c:122: }
      00017E D0 D0            [24]  697 	pop	psw
      000180 D0 00            [24]  698 	pop	ar0
      000182 D0 E0            [24]  699 	pop	acc
      000184 32               [24]  700 	reti
                                    ...
                                    707 ;------------------------------------------------------------
                                    708 ;	src/main.c:124: void main(void){
                                    709 ;	-----------------------------------------
                                    710 ;	 function main
                                    711 ;	-----------------------------------------
      000185                        712 _main:
                                    713 ;	src/main.c:125: init_mpu();
      000185 12 00 CB         [24]  714 	lcall	_init_mpu
                                    715 ;	src/main.c:127: init_serial();
      000188 12 00 FF         [24]  716 	lcall	_init_serial
                                    717 ;	src/main.c:129: while(1){
      00018B                        718 00102$:
                                    719 ;	src/main.c:130: put_char('A');
      00018B 75 82 41         [24]  720 	mov	dpl, #0x41
      00018E 12 01 14         [24]  721 	lcall	_put_char
                                    722 ;	src/main.c:133: }
      000191 80 F8            [24]  723 	sjmp	00102$
                                    724 	.area CSEG    (CODE)
                                    725 	.area CONST   (CODE)
                                    726 	.area XINIT   (CODE)
