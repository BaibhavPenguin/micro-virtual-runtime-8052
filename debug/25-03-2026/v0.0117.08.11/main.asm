...
;	include/uvr_variable.h:21: volatile unsigned char __data __at (0x38) temp_0 = 0;
	mov	_temp_0,#0x00
...
;------------------------------------------------------------
;	src/main.c:28: void put_char(char dat){
;	-----------------------------------------
;	 function put_char
;	-----------------------------------------
_put_char:
	mov	_SBUF,dpl
;	src/main.c:30: while(!TI);
00101$:
;	src/main.c:31: TI = 0;
;	assignBit
	jbc	_TI,00118$
...
;------------------------------------------------------------
;	src/main.c:44: void delay_ms_500(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	src/main.c:52: void ascii_to_hex(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	src/main.c:61: void hex_to_ascii(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	src/main.c:69: void print_boot_message(void){
;	-----------------------------------------
;	 function print_boot_message
;	-----------------------------------------
_print_boot_message:
;	src/main.c:71: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
	mov	dpl, #0x44
	lcall	_put_char
	mov	dpl, #0x65
	lcall	_put_char
...
;------------------------------------------------------------
;	src/main.c:77: void Serial_ISR(void) __interrupt(4)
;	-----------------------------------------
;	 function Serial_ISR
;	-----------------------------------------
_Serial_ISR:
...
;	src/main.c:79: if(RI){
	jnb	_RI,00103$
;	src/main.c:80: *wr_pointer = SBUF;
	mov	dptr,#_wr_pointer
	movx	a,@dptr
	mov	r1,a
	mov	@r1,_SBUF
;	src/main.c:81: is_recieved = 1;
;	assignBit
	setb	_is_recieved
;	src/main.c:82: wr_pointer++;
	mov	dptr,#_wr_pointer
	mov	a,r1
	inc	a
	movx	@dptr,a
...
;	-----------------------------------------
_main:
;	src/main.c:90: SP = hw_stack; 		//initiaslze Stack Pointer;
	mov	_SP,#0x60
;	src/main.c:91: init_mem();
	lcall	_init_mem
;	src/main.c:92: init_serial();
	lcall	_init_serial
;	src/main.c:93: while(1){
00102$:
;	src/main.c:94: put_char('A');
	mov	dpl, #0x41
	lcall	_put_char
;	src/main.c:96: }
	sjmp	00102$
