      ...
      00001C                        378 	.ds	7
      000023 02 01 58         [24]  379 	ljmp	_Serial_ISR
      ...
      000069 02 01 7C         [24]  461 	ljmp	_main
      ...
      000108 D2 8E            [12]  547 	setb	_TR1
                                    548 ;	src/main.c:44: SCON = 0x50;				//Serial Mode 1 , 8 Bit UART
      00010A 75 98 50         [24]  549 	mov	_SCON,#0x50
                                    550 ;	src/main.c:45: ES = 1;						//Enable Serial interrupt
                                    551 ;	assignBit
      00010D D2 AC            [12]  552 	setb	_ES
                                    553 ;	src/main.c:47: }
      00010F 22               [24]  554 	ret
                                    555 ;------------------------------------------------------------
                                    556 ;Allocation info for local variables in function 'put_char'
                                    557 ;------------------------------------------------------------
                                    558 ;args          Allocated to registers r7 
                                    559 ;------------------------------------------------------------
                                    560 ;	src/main.c:50: void put_char(char args){
                                    561 ;	-----------------------------------------
                                    562 ;	 function put_char
                                    563 ;	-----------------------------------------
      000110                        564 _put_char:
      000110 AF 82            [24]  565 	mov	r7, dpl
                                    566 ;	src/main.c:51: while(serial_busy);
      000112                        567 00101$:
      000112 E5 38            [12]  568 	mov	a,_serial_busy
      000114 70 FC            [24]  569 	jnz	00101$
                                    570 ;	src/main.c:52: serial_busy = 1;
      000116 75 38 01         [24]  571 	mov	_serial_busy,#0x01
                                    572 ;	src/main.c:53: SBUF = args;
      000119 8F 99            [24]  573 	mov	_SBUF,r7
                                    574 ;	src/main.c:56: }
      00011B 22               [24]  575 	ret
                                    576 ;------------------------------------------------------------
                                    577 ;Allocation info for local variables in function 'echo'
                                    578 ;------------------------------------------------------------
                                    579 ;	src/main.c:58: void echo(void){
                                    580 ;	-----------------------------------------
                                    581 ;	 function echo
                                    582 ;	-----------------------------------------
      00011C                        583 _echo:
                                    584 ;	src/main.c:59: serial_busy = 1;
      00011C 75 38 01         [24]  585 	mov	_serial_busy,#0x01
                                    586 ;	src/main.c:60: while(rd_pointer == wr_pointer);
      00011F                        587 00101$:
      00011F E5 33            [12]  588 	mov	a,_wr_pointer
      000121 B5 32 02         [24]  589 	cjne	a,_rd_pointer,00133$
      000124 80 F9            [24]  590 	sjmp	00101$
      000126                        591 00133$:
                                    592 ;	src/main.c:61: SBUF = *rd_pointer;
      000126 A9 32            [24]  593 	mov	r1,_rd_pointer
      000128 87 99            [24]  594 	mov	_SBUF,@r1
                                    595 ;	src/main.c:62: while(serial_busy);
      00012A                        596 00104$:
      00012A E5 38            [12]  597 	mov	a,_serial_busy
      00012C 70 FC            [24]  598 	jnz	00104$
                                    599 ;	src/main.c:63: rd_pointer++;
      00012E 05 32            [12]  600 	inc	_rd_pointer
                                    601 ;	src/main.c:65: }
      000130 22               [24]  602 	ret
                                    603 ;------------------------------------------------------------
                                    604 ;Allocation info for local variables in function 'delay_ms_500'
                                    605 ;------------------------------------------------------------
                                    606 ;	src/main.c:71: void delay_ms_500(void){
                                    607 ;	-----------------------------------------
                                    608 ;	 function delay_ms_500
                                    609 ;	-----------------------------------------
      000131                        610 _delay_ms_500:
                                    611 ;	src/main.c:74: }
      000131 22               [24]  612 	ret
                                    613 ;------------------------------------------------------------
                                    614 ;Allocation info for local variables in function 'ascii_to_hex'
                                    615 ;------------------------------------------------------------
                                    616 ;	src/main.c:79: void ascii_to_hex(void){
                                    617 ;	-----------------------------------------
                                    618 ;	 function ascii_to_hex
                                    619 ;	-----------------------------------------
      000132                        620 _ascii_to_hex:
                                    621 ;	src/main.c:82: }
      000132 22               [24]  622 	ret
                                    623 ;------------------------------------------------------------
                                    624 ;Allocation info for local variables in function 'hex_to_ascii'
                                    625 ;------------------------------------------------------------
                                    626 ;	src/main.c:88: void hex_to_ascii(void){
                                    627 ;	-----------------------------------------
                                    628 ;	 function hex_to_ascii
                                    629 ;	-----------------------------------------
      000133                        630 _hex_to_ascii:
                                    631 ;	src/main.c:91: }
      000133 22               [24]  632 	ret
                                    633 ;------------------------------------------------------------
                                    634 ;Allocation info for local variables in function 'print_boot_message'
                                    635 ;------------------------------------------------------------
                                    636 ;	src/main.c:96: void print_boot_message(void){
                                    637 ;	-----------------------------------------
                                    638 ;	 function print_boot_message
                                    639 ;	-----------------------------------------
      000134                        640 _print_boot_message:
                                    641 ;	src/main.c:98: put_char('D');put_char('e');put_char('b');put_char('u');put_char('g');put_char('\n');
      000134 75 82 44         [24]  642 	mov	dpl, #0x44
      000137 12 01 10         [24]  643 	lcall	_put_char
      00013A 75 82 65         [24]  644 	mov	dpl, #0x65
      00013D 12 01 10         [24]  645 	lcall	_put_char
      000140 75 82 62         [24]  646 	mov	dpl, #0x62
      000143 12 01 10         [24]  647 	lcall	_put_char
      000146 75 82 75         [24]  648 	mov	dpl, #0x75
      000149 12 01 10         [24]  649 	lcall	_put_char
      00014C 75 82 67         [24]  650 	mov	dpl, #0x67
      00014F 12 01 10         [24]  651 	lcall	_put_char
      000152 75 82 0A         [24]  652 	mov	dpl, #0x0a
                                    653 ;	src/main.c:100: }
      000155 02 01 10         [24]  654 	ljmp	_put_char
                                    655 ;------------------------------------------------------------
                                    656 ;Allocation info for local variables in function 'Serial_ISR'
                                    657 ;------------------------------------------------------------
                                    658 ;	src/main.c:108: void Serial_ISR(void) __interrupt (4)
                                    659 ;	-----------------------------------------
                                    660 ;	 function Serial_ISR
                                    661 ;	-----------------------------------------
      000158                        662 _Serial_ISR:
      000158 C0 E0            [24]  663 	push	acc
      00015A C0 00            [24]  664 	push	ar0
      00015C C0 D0            [24]  665 	push	psw
      00015E 75 D0 00         [24]  666 	mov	psw,#0x00
                                    667 ;	src/main.c:110: if(RI){						//Recieve Interrput == RI
      000161 30 98 09         [24]  668 	jnb	_RI,00102$
                                    669 ;	src/main.c:111: *wr_pointer = SBUF;		//Store Input Data in Buffer
      000164 E5 33            [12]  670 	mov	a,_wr_pointer
      000166 F8               [12]  671 	mov	r0,a
      000167 A6 99            [24]  672 	mov	@r0,_SBUF
                                    673 ;	src/main.c:112: wr_pointer++;
      000169 05 33            [12]  674 	inc	_wr_pointer
                                    675 ;	src/main.c:113: RI = 0;
                                    676 ;	assignBit
      00016B C2 98            [12]  677 	clr	_RI
      00016D                        678 00102$:
                                    679 ;	src/main.c:116: if(TI){
                                    680 ;	src/main.c:117: TI = 0;
                                    681 ;	assignBit
      00016D 10 99 02         [24]  682 	jbc	_TI,00120$
      000170 80 03            [24]  683 	sjmp	00105$
      000172                        684 00120$:
                                    685 ;	src/main.c:118: serial_busy = 0;
      000172 75 38 00         [24]  686 	mov	_serial_busy,#0x00
      000175                        687 00105$:
                                    688 ;	src/main.c:120: }
      000175 D0 D0            [24]  689 	pop	psw
      000177 D0 00            [24]  690 	pop	ar0
      000179 D0 E0            [24]  691 	pop	acc
      00017B 32               [24]  692 	reti
                                    693 ;	eliminated unneeded push/pop ar1
                                    694 ;	eliminated unneeded push/pop dpl
                                    695 ;	eliminated unneeded push/pop dph
                                    696 ;	eliminated unneeded push/pop b
                                    697 ;------------------------------------------------------------
                                    698 ;Allocation info for local variables in function 'main'
                                    699 ;------------------------------------------------------------
                                    700 ;	src/main.c:122: void main(void){
                                    701 ;	-----------------------------------------
                                    702 ;	 function main
                                    703 ;	-----------------------------------------
      00017C                        704 _main:
                                    705 ;	src/main.c:123: init_mpu();
      00017C 12 00 CB         [24]  706 	lcall	_init_mpu
                                    707 ;	src/main.c:125: init_serial();
      00017F 12 00 FF         [24]  708 	lcall	_init_serial
                                    709 ;	src/main.c:126: while(1){
      000182                        710 00102$:
                                    711 ;	src/main.c:127: put_char('A');
      000182 75 82 41         [24]  712 	mov	dpl, #0x41
      000185 12 01 10         [24]  713 	lcall	_put_char
                                    714 ;	src/main.c:129: }
      000188 80 F8            [24]  715 	sjmp	00102$
                                    716 	.area CSEG    (CODE)
                                    717 	.area CONST   (CODE)
                                    718 	.area XINIT   (CODE)
