                                    ...
                                    150 	.globl _temp1
                                    151 	.globl _temp0
                                    152 	.globl _active_timer
                                    153 	.globl _op2
                                    154 	.globl _op1
                                    155 	.globl _system_tick
      ...
      00001C                        413 	.ds	7
      000023 02 01 A1         [24]  414 	ljmp	_Serial_ISR
      000026                        415 	.ds	5
      00002B 02 01 CD         [24]  416 	ljmp	_Timer2_ISR
      ...
      000071 02 01 D7         [24]  531 	ljmp	_main
      ...
      000138 22               [24]  633 	ret
                                    ...
                                    640 ;	-----------------------------------------
      000139                        641 _echo:
                                    642 ;	src/main.c:46: rd_pointer = &prog_buffer[0];
      000139 90 00 32         [24]  643 	mov	dptr,#_rd_pointer
      00013C 74 40            [12]  644 	mov	a,#_prog_buffer
      00013E F0               [24]  645 	movx	@dptr,a
                                    646 ;	src/main.c:47: while(!is_recieved);
      00013F                        647 00101$:
      00013F 30 00 FD         [24]  648 	jnb	_is_recieved,00101$
                                    649 ;	src/main.c:48: uart_send(*rd_pointer);
      000142 85 40 82         [24]  650 	mov	dpl,_prog_buffer
      000145 12 01 30         [24]  651 	lcall	_uart_send
                                    652 ;	src/main.c:49: rd_pointer++;
      000148 90 00 32         [24]  653 	mov	dptr,#_rd_pointer
      00014B E0               [24]  654 	movx	a,@dptr
      00014C 24 01            [12]  655 	add	a, #0x01
      00014E F0               [24]  656 	movx	@dptr,a
                                    657 ;	src/main.c:50: is_recieved = 0;
                                    658 ;	assignBit
      00014F C2 00            [12]  659 	clr	_is_recieved
                                    660 ;	src/main.c:52: }
      000151 22               [24]  661 	ret
                                    662 ;------------------------------------------------------------
                                    663 ;Allocation info for local variables in function 'delay_ms_500'
                                    664 ;------------------------------------------------------------
                                    665 ;	src/main.c:58: void delay_ms_500(void){
                                    666 ;	-----------------------------------------
                                    667 ;	 function delay_ms_500
                                    668 ;	-----------------------------------------
      000152                        669 _delay_ms_500:
                                    670 ;	src/main.c:61: }
      000152 22               [24]  671 	ret
                                    672 ;------------------------------------------------------------
                                    673 ;Allocation info for local variables in function 'ascii_to_hex'
                                    674 ;------------------------------------------------------------
                                    675 ;	src/main.c:66: void ascii_to_hex(void){
                                    676 ;	-----------------------------------------
                                    677 ;	 function ascii_to_hex
                                    678 ;	-----------------------------------------
      000153                        679 _ascii_to_hex:
                                    680 ;	src/main.c:69: }
      000153 22               [24]  681 	ret
                                    682 ;------------------------------------------------------------
                                    683 ;Allocation info for local variables in function 'hex_to_ascii'
                                    684 ;------------------------------------------------------------
                                    685 ;	src/main.c:75: void hex_to_ascii(void){
                                    686 ;	-----------------------------------------
                                    687 ;	 function hex_to_ascii
                                    688 ;	-----------------------------------------
      000154                        689 _hex_to_ascii:
                                    690 ;	src/main.c:78: }
      000154 22               [24]  691 	ret
                                    692 ;------------------------------------------------------------
                                    693 ;Allocation info for local variables in function 'print_boot_message'
                                    694 ;------------------------------------------------------------
                                    695 ;	src/main.c:83: void print_boot_message(void){
                                    696 ;	-----------------------------------------
                                    697 ;	 function print_boot_message
                                    698 ;	-----------------------------------------
      000155                        699 _print_boot_message:
                                    700 ;	src/main.c:84: temp0 = 0;
      000155 75 38 00         [24]  701 	mov	_temp0,#0x00
                                    702 ;	src/main.c:85: while(temp0 != len_boot_message){
      000158                        703 00101$:
      000158 74 36            [12]  704 	mov	a,#0x36
      00015A B5 38 02         [24]  705 	cjne	a,_temp0,00118$
      00015D 80 12            [24]  706 	sjmp	00103$
      00015F                        707 00118$:
                                    708 ;	src/main.c:86: uart_send(boot_message[temp0]);
      00015F E5 38            [12]  709 	mov	a,_temp0
      000161 90 01 F2         [24]  710 	mov	dptr,#_boot_message
      000164 93               [24]  711 	movc	a,@a+dptr
      000165 F5 82            [12]  712 	mov	dpl,a
      000167 12 01 30         [24]  713 	lcall	_uart_send
                                    714 ;	src/main.c:87: temp0++;
      00016A E5 38            [12]  715 	mov	a,_temp0
      00016C 04               [12]  716 	inc	a
      00016D F5 38            [12]  717 	mov	_temp0,a
      00016F 80 E7            [24]  718 	sjmp	00101$
      000171                        719 00103$:
                                    720 ;	src/main.c:89: temp0 = 0;
      000171 75 38 00         [24]  721 	mov	_temp0,#0x00
                                    722 ;	src/main.c:90: }
      000174 22               [24]  723 	ret
                                    724 ;------------------------------------------------------------
                                    725 ;Allocation info for local variables in function 'print_ready_message'
                                    726 ;------------------------------------------------------------
                                    727 ;	src/main.c:92: void print_ready_message(void){
                                    728 ;	-----------------------------------------
                                    729 ;	 function print_ready_message
                                    730 ;	-----------------------------------------
      000175                        731 _print_ready_message:
                                    732 ;	src/main.c:93: temp0 = 0;
      000175 75 38 00         [24]  733 	mov	_temp0,#0x00
                                    734 ;	src/main.c:94: while(temp0 != len_ready_message){
      000178                        735 00101$:
      000178 74 07            [12]  736 	mov	a,#0x07
      00017A B5 38 02         [24]  737 	cjne	a,_temp0,00118$
      00017D 80 12            [24]  738 	sjmp	00103$
      00017F                        739 00118$:
                                    740 ;	src/main.c:95: uart_send(ready_msg[temp0]);
      00017F E5 38            [12]  741 	mov	a,_temp0
      000181 90 02 28         [24]  742 	mov	dptr,#_ready_msg
      000184 93               [24]  743 	movc	a,@a+dptr
      000185 F5 82            [12]  744 	mov	dpl,a
      000187 12 01 30         [24]  745 	lcall	_uart_send
                                    746 ;	src/main.c:96: temp0++;
      00018A E5 38            [12]  747 	mov	a,_temp0
      00018C 04               [12]  748 	inc	a
      00018D F5 38            [12]  749 	mov	_temp0,a
      00018F 80 E7            [24]  750 	sjmp	00101$
      000191                        751 00103$:
                                    752 ;	src/main.c:98: temp0 = 0;
      000191 75 38 00         [24]  753 	mov	_temp0,#0x00
                                    754 ;	src/main.c:99: }
      000194 22               [24]  755 	ret
                                    756 ;------------------------------------------------------------
                                    757 ;Allocation info for local variables in function 'clear_terminal'
                                    758 ;------------------------------------------------------------
                                    759 ;	src/main.c:101: void clear_terminal(void){
                                    760 ;	-----------------------------------------
                                    761 ;	 function clear_terminal
                                    762 ;	-----------------------------------------
      000195                        763 _clear_terminal:
                                    764 ;	src/main.c:104: uart_send(0x1B);uart_send(0x63); //Full Reset Terminal
      000195 75 82 1B         [24]  765 	mov	dpl, #0x1b
      000198 12 01 30         [24]  766 	lcall	_uart_send
      00019B 75 82 63         [24]  767 	mov	dpl, #0x63
                                    768 ;	src/main.c:105: }
      00019E 02 01 30         [24]  769 	ljmp	_uart_send
                                    770 ;------------------------------------------------------------
                                    771 ;Allocation info for local variables in function 'Serial_ISR'
                                    772 ;------------------------------------------------------------
                                    773 ;	src/main.c:109: void Serial_ISR(void) __interrupt(4)
                                    774 ;	-----------------------------------------
                                    775 ;	 function Serial_ISR
                                    776 ;	-----------------------------------------
      0001A1                        777 _Serial_ISR:
      0001A1 C0 E0            [24]  778 	push	acc
      0001A3 C0 82            [24]  779 	push	dpl
      0001A5 C0 83            [24]  780 	push	dph
      0001A7 C0 01            [24]  781 	push	ar1
      0001A9 C0 D0            [24]  782 	push	psw
      0001AB 75 D0 00         [24]  783 	mov	psw,#0x00
                                    784 ;	src/main.c:111: if(RI){
      0001AE 30 98 11         [24]  785 	jnb	_RI,00103$
                                    786 ;	src/main.c:112: *wr_pointer = SBUF;
      0001B1 90 00 33         [24]  787 	mov	dptr,#_wr_pointer
      0001B4 E0               [24]  788 	movx	a,@dptr
      0001B5 F9               [12]  789 	mov	r1,a
      0001B6 A7 99            [24]  790 	mov	@r1,_SBUF
                                    791 ;	src/main.c:113: is_recieved = 1;
                                    792 ;	assignBit
      0001B8 D2 00            [12]  793 	setb	_is_recieved
                                    794 ;	src/main.c:114: wr_pointer++;
      0001BA 90 00 33         [24]  795 	mov	dptr,#_wr_pointer
      0001BD E9               [12]  796 	mov	a,r1
      0001BE 04               [12]  797 	inc	a
      0001BF F0               [24]  798 	movx	@dptr,a
                                    799 ;	src/main.c:115: RI = 0;
                                    800 ;	assignBit
      0001C0 C2 98            [12]  801 	clr	_RI
      0001C2                        802 00103$:
                                    803 ;	src/main.c:117: }
      0001C2 D0 D0            [24]  804 	pop	psw
      0001C4 D0 01            [24]  805 	pop	ar1
      0001C6 D0 83            [24]  806 	pop	dph
      0001C8 D0 82            [24]  807 	pop	dpl
      0001CA D0 E0            [24]  808 	pop	acc
      0001CC 32               [24]  809 	reti
                                    810 ;	eliminated unneeded push/pop ar0
                                    811 ;	eliminated unneeded push/pop b
                                    812 ;------------------------------------------------------------
                                    813 ;Allocation info for local variables in function 'Timer2_ISR'
                                    814 ;------------------------------------------------------------
                                    815 ;	src/main.c:120: void Timer2_ISR(void) __interrupt(5)
                                    816 ;	-----------------------------------------
                                    817 ;	 function Timer2_ISR
                                    818 ;	-----------------------------------------
      0001CD                        819 _Timer2_ISR:
      0001CD C0 E0            [24]  820 	push	acc
                                    821 ;	src/main.c:122: system_tick++;
      0001CF E5 34            [12]  822 	mov	a,_system_tick
      0001D1 04               [12]  823 	inc	a
      0001D2 F5 34            [12]  824 	mov	_system_tick,a
                                    825 ;	src/main.c:123: }
      0001D4 D0 E0            [24]  826 	pop	acc
      0001D6 32               [24]  827 	reti
                                    828 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    829 ;	eliminated unneeded push/pop not_psw
                                    830 ;	eliminated unneeded push/pop dpl
                                    831 ;	eliminated unneeded push/pop dph
                                    832 ;	eliminated unneeded push/pop b
                                    833 ;------------------------------------------------------------
                                    834 ;Allocation info for local variables in function 'main'
                                    835 ;------------------------------------------------------------
                                    836 ;	src/main.c:126: void main(void){
                                    837 ;	-----------------------------------------
                                    838 ;	 function main
                                    839 ;	-----------------------------------------
      0001D7                        840 _main:
                                    841 ;	src/main.c:127: SP = hw_stack; 		//initiaslze Stack Pointer;
      0001D7 75 81 60         [24]  842 	mov	_SP,#0x60
                                    843 ;	src/main.c:128: init_sys();
      0001DA 12 01 04         [24]  844 	lcall	_init_sys
                                    845 ;	src/main.c:129: init_serial();
      0001DD 12 01 1F         [24]  846 	lcall	_init_serial
                                    847 ;	src/main.c:133: clear_terminal();
      0001E0 12 01 95         [24]  848 	lcall	_clear_terminal
                                    849 ;	src/main.c:134: print_boot_message();
      0001E3 12 01 55         [24]  850 	lcall	_print_boot_message
                                    851 ;	src/main.c:135: print_ready_message();
      0001E6 12 01 75         [24]  852 	lcall	_print_ready_message
                                    853 ;	src/main.c:137: while(1){
      0001E9                        854 00102$:
                                    855 ;	src/main.c:138: echo();
      0001E9 12 01 39         [24]  856 	lcall	_echo
                                    857 ;	src/main.c:140: }
      0001EC 80 FB            [24]  858 	sjmp	00102$
                                    859 	.area CSEG    (CODE)
                                    860 	.area CONST   (CODE)
                                    861 	.area CONST   (CODE)
      0001F2                        862 _boot_message:
      0001F2 4D                     863 	.db #0x4d	; 77	'M'
      0001F3 69                     864 	.db #0x69	; 105	'i'
      0001F4 63                     865 	.db #0x63	; 99	'c'
      0001F5 72                     866 	.db #0x72	; 114	'r'
      0001F6 6F                     867 	.db #0x6f	; 111	'o'
      0001F7 20                     868 	.db #0x20	; 32
      0001F8 56                     869 	.db #0x56	; 86	'V'
      0001F9 69                     870 	.db #0x69	; 105	'i'
      0001FA 72                     871 	.db #0x72	; 114	'r'
      0001FB 74                     872 	.db #0x74	; 116	't'
      0001FC 75                     873 	.db #0x75	; 117	'u'
      0001FD 61                     874 	.db #0x61	; 97	'a'
      0001FE 6C                     875 	.db #0x6c	; 108	'l'
      0001FF 2D                     876 	.db #0x2d	; 45
      000200 52                     877 	.db #0x52	; 82	'R'
      000201 20                     878 	.db #0x20	; 32
      000202 43                     879 	.db #0x43	; 67	'C'
      000203 6F                     880 	.db #0x6f	; 111	'o'
      000204 70                     881 	.db #0x70	; 112	'p'
      000205 79                     882 	.db #0x79	; 121	'y'
      000206 72                     883 	.db #0x72	; 114	'r'
      000207 69                     884 	.db #0x69	; 105	'i'
      000208 67                     885 	.db #0x67	; 103	'g'
      000209 68                     886 	.db #0x68	; 104	'h'
      00020A 74                     887 	.db #0x74	; 116	't'
      00020B 20                     888 	.db #0x20	; 32
      00020C 32                     889 	.db #0x32	; 50	'2'
      00020D 30                     890 	.db #0x30	; 48	'0'
      00020E 32                     891 	.db #0x32	; 50	'2'
      00020F 36                     892 	.db #0x36	; 54	'6'
      000210 20                     893 	.db #0x20	; 32
      000211 42                     894 	.db #0x42	; 66	'B'
      000212 61                     895 	.db #0x61	; 97	'a'
      000213 69                     896 	.db #0x69	; 105	'i'
      000214 62                     897 	.db #0x62	; 98	'b'
      000215 68                     898 	.db #0x68	; 104	'h'
      000216 61                     899 	.db #0x61	; 97	'a'
      000217 76                     900 	.db #0x76	; 118	'v'
      000218 20                     901 	.db #0x20	; 32
      000219 42                     902 	.db #0x42	; 66	'B'
      00021A 68                     903 	.db #0x68	; 104	'h'
      00021B 61                     904 	.db #0x61	; 97	'a'
      00021C 74                     905 	.db #0x74	; 116	't'
      00021D 74                     906 	.db #0x74	; 116	't'
      00021E 61                     907 	.db #0x61	; 97	'a'
      00021F 63                     908 	.db #0x63	; 99	'c'
      000220 68                     909 	.db #0x68	; 104	'h'
      000221 72                     910 	.db #0x72	; 114	'r'
      000222 79                     911 	.db #0x79	; 121	'y'
      000223 61                     912 	.db #0x61	; 97	'a'
      000224 0D                     913 	.db #0x0d	; 13
      000225 0A                     914 	.db #0x0a	; 10
      000226 00                     915 	.db 0x00
      000227 00                     916 	.db 0x00
                                    917 	.area CSEG    (CODE)
                                    918 	.area CONST   (CODE)
      000228                        919 _ready_msg:
      000228 52                     920 	.db #0x52	; 82	'R'
      000229 45                     921 	.db #0x45	; 69	'E'
      00022A 41                     922 	.db #0x41	; 65	'A'
      00022B 44                     923 	.db #0x44	; 68	'D'
      00022C 59                     924 	.db #0x59	; 89	'Y'
      00022D 0D                     925 	.db #0x0d	; 13
      00022E 0A                     926 	.db #0x0a	; 10
                                    927 	.area CSEG    (CODE)
                                    928 	.area XINIT   (CODE)
