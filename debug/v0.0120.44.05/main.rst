      ...
      00001C                        413 	.ds	7
      000023 02 01 89         [24]  414 	ljmp	_Serial_ISR
      000026                        415 	.ds	5
      00002B 02 01 B5         [24]  416 	ljmp	_Timer2_ISR
      ...
      000071 02 01 BF         [24]  531 	ljmp	_main
      ...
      00013D 75 38 00         [24]  683 	mov	_temp0,#0x00
                                    684 ;	src/main.c:80: while(temp0 != len_boot_message){
      000140                        685 00101$:
      ...
      000149 90 01 D7         [24]  692 	mov	dptr,#_boot_message
      ...
      00015D 75 38 00         [24]  715 	mov	_temp0,#0x00
                                    716 ;	src/main.c:89: while(temp0 != len_ready_message){
      000160                        717 00101$:
      ...
      000169 90 02 0D         [24]  724 	mov	dptr,#_ready_msg
      ...
      00017D                        745 _clear_terminal:
                                    746 ;	src/main.c:99: uart_send(0x1B);uart_send(0x63); //Full Reset Terminal
      00017D 75 82 1B         [24]  747 	mov	dpl, #0x1b
      000180 12 01 30         [24]  748 	lcall	_uart_send
      000183 75 82 63         [24]  749 	mov	dpl, #0x63
                                    750 ;	src/main.c:100: }
      000186 02 01 30         [24]  751 	ljmp	_uart_send
                                    752 ;------------------------------------------------------------
                                    753 ;Allocation info for local variables in function 'Serial_ISR'
                                    754 ;------------------------------------------------------------
                                    755 ;	src/main.c:104: void Serial_ISR(void) __interrupt(4)
                                    756 ;	-----------------------------------------
                                    757 ;	 function Serial_ISR
                                    758 ;	-----------------------------------------
      000189                        759 _Serial_ISR:
      000189 C0 E0            [24]  760 	push	acc
      00018B C0 82            [24]  761 	push	dpl
      00018D C0 83            [24]  762 	push	dph
      00018F C0 01            [24]  763 	push	ar1
      000191 C0 D0            [24]  764 	push	psw
      000193 75 D0 00         [24]  765 	mov	psw,#0x00
                                    766 ;	src/main.c:106: if(RI){
      000196 30 98 11         [24]  767 	jnb	_RI,00103$
                                    768 ;	src/main.c:107: *wr_pointer = SBUF;
      000199 90 00 33         [24]  769 	mov	dptr,#_wr_pointer
      00019C E0               [24]  770 	movx	a,@dptr
      00019D F9               [12]  771 	mov	r1,a
      00019E A7 99            [24]  772 	mov	@r1,_SBUF
                                    773 ;	src/main.c:108: is_recieved = 1;
                                    774 ;	assignBit
      0001A0 D2 00            [12]  775 	setb	_is_recieved
                                    776 ;	src/main.c:109: wr_pointer++;
      0001A2 90 00 33         [24]  777 	mov	dptr,#_wr_pointer
      0001A5 E9               [12]  778 	mov	a,r1
      0001A6 04               [12]  779 	inc	a
      0001A7 F0               [24]  780 	movx	@dptr,a
                                    781 ;	src/main.c:110: RI = 0;
                                    782 ;	assignBit
      0001A8 C2 98            [12]  783 	clr	_RI
      0001AA                        784 00103$:
                                    785 ;	src/main.c:112: }
      0001AA D0 D0            [24]  786 	pop	psw
      0001AC D0 01            [24]  787 	pop	ar1
      0001AE D0 83            [24]  788 	pop	dph
      0001B0 D0 82            [24]  789 	pop	dpl
      0001B2 D0 E0            [24]  790 	pop	acc
      0001B4 32               [24]  791 	reti
                                    792 ;	eliminated unneeded push/pop ar0
                                    793 ;	eliminated unneeded push/pop b
                                    794 ;------------------------------------------------------------
                                    795 ;Allocation info for local variables in function 'Timer2_ISR'
                                    796 ;------------------------------------------------------------
                                    797 ;	src/main.c:115: void Timer2_ISR(void) __interrupt(5)
                                    798 ;	-----------------------------------------
                                    799 ;	 function Timer2_ISR
                                    800 ;	-----------------------------------------
      0001B5                        801 _Timer2_ISR:
      0001B5 C0 E0            [24]  802 	push	acc
                                    803 ;	src/main.c:117: system_tick++;
      0001B7 E5 34            [12]  804 	mov	a,_system_tick
      0001B9 04               [12]  805 	inc	a
      0001BA F5 34            [12]  806 	mov	_system_tick,a
                                    807 ;	src/main.c:118: }
      0001BC D0 E0            [24]  808 	pop	acc
      0001BE 32               [24]  809 	reti
                                    810 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    811 ;	eliminated unneeded push/pop not_psw
                                    ...
                                    817 ;------------------------------------------------------------
                                    818 ;	src/main.c:121: void main(void){
                                    819 ;	-----------------------------------------
                                    820 ;	 function main
                                    821 ;	-----------------------------------------
      0001BF                        822 _main:
                                    823 ;	src/main.c:122: SP = hw_stack; 		//initiaslze Stack Pointer;
      0001BF 75 81 60         [24]  824 	mov	_SP,#0x60
                                    825 ;	src/main.c:123: init_sys();
      0001C2 12 01 04         [24]  826 	lcall	_init_sys
                                    827 ;	src/main.c:124: init_serial();
      0001C5 12 01 1F         [24]  828 	lcall	_init_serial
                                    829 ;	src/main.c:128: clear_terminal();
      0001C8 12 01 7D         [24]  830 	lcall	_clear_terminal
                                    831 ;	src/main.c:129: print_boot_message();
      0001CB 12 01 3D         [24]  832 	lcall	_print_boot_message
                                    833 ;	src/main.c:130: print_ready_message();
      0001CE 12 01 5D         [24]  834 	lcall	_print_ready_message
                                    835 ;	src/main.c:132: while(1);
      0001D1                        836 00102$:
                                    837 ;	src/main.c:133: }
      0001D1 80 FE            [24]  838 	sjmp	00102$
                                    839 	.area CSEG    (CODE)
                                    840 	.area CONST   (CODE)
                                    841 	.area CONST   (CODE)
      0001D7                        842 _boot_message:
      0001D7 4D                     843 	.db #0x4d	; 77	'M'
      0001D8 69                     844 	.db #0x69	; 105	'i'
      0001D9 63                     845 	.db #0x63	; 99	'c'
      0001DA 72                     846 	.db #0x72	; 114	'r'
      0001DB 6F                     847 	.db #0x6f	; 111	'o'
      0001DC 20                     848 	.db #0x20	; 32
      0001DD 56                     849 	.db #0x56	; 86	'V'
      0001DE 69                     850 	.db #0x69	; 105	'i'
      0001DF 72                     851 	.db #0x72	; 114	'r'
      0001E0 74                     852 	.db #0x74	; 116	't'
      0001E1 75                     853 	.db #0x75	; 117	'u'
      0001E2 61                     854 	.db #0x61	; 97	'a'
      0001E3 6C                     855 	.db #0x6c	; 108	'l'
      0001E4 2D                     856 	.db #0x2d	; 45
      0001E5 52                     857 	.db #0x52	; 82	'R'
      0001E6 20                     858 	.db #0x20	; 32
      0001E7 43                     859 	.db #0x43	; 67	'C'
      0001E8 6F                     860 	.db #0x6f	; 111	'o'
      0001E9 70                     861 	.db #0x70	; 112	'p'
      0001EA 79                     862 	.db #0x79	; 121	'y'
      0001EB 72                     863 	.db #0x72	; 114	'r'
      0001EC 69                     864 	.db #0x69	; 105	'i'
      0001ED 67                     865 	.db #0x67	; 103	'g'
      0001EE 68                     866 	.db #0x68	; 104	'h'
      0001EF 74                     867 	.db #0x74	; 116	't'
      0001F0 20                     868 	.db #0x20	; 32
      0001F1 32                     869 	.db #0x32	; 50	'2'
      0001F2 30                     870 	.db #0x30	; 48	'0'
      0001F3 32                     871 	.db #0x32	; 50	'2'
      0001F4 36                     872 	.db #0x36	; 54	'6'
      0001F5 20                     873 	.db #0x20	; 32
      0001F6 42                     874 	.db #0x42	; 66	'B'
      0001F7 61                     875 	.db #0x61	; 97	'a'
      0001F8 69                     876 	.db #0x69	; 105	'i'
      0001F9 62                     877 	.db #0x62	; 98	'b'
      0001FA 68                     878 	.db #0x68	; 104	'h'
      0001FB 61                     879 	.db #0x61	; 97	'a'
      0001FC 76                     880 	.db #0x76	; 118	'v'
      0001FD 20                     881 	.db #0x20	; 32
      0001FE 42                     882 	.db #0x42	; 66	'B'
      0001FF 68                     883 	.db #0x68	; 104	'h'
      000200 61                     884 	.db #0x61	; 97	'a'
      000201 74                     885 	.db #0x74	; 116	't'
      000202 74                     886 	.db #0x74	; 116	't'
      000203 61                     887 	.db #0x61	; 97	'a'
      000204 63                     888 	.db #0x63	; 99	'c'
      000205 68                     889 	.db #0x68	; 104	'h'
      000206 72                     890 	.db #0x72	; 114	'r'
      000207 79                     891 	.db #0x79	; 121	'y'
      000208 61                     892 	.db #0x61	; 97	'a'
      000209 0D                     893 	.db #0x0d	; 13
      00020A 0A                     894 	.db #0x0a	; 10
      00020B 00                     895 	.db 0x00
      00020C 00                     896 	.db 0x00
                                    897 	.area CSEG    (CODE)
                                    898 	.area CONST   (CODE)
      00020D                        899 _ready_msg:
      00020D 52                     900 	.db #0x52	; 82	'R'
      00020E 45                     901 	.db #0x45	; 69	'E'
      00020F 41                     902 	.db #0x41	; 65	'A'
      000210 44                     903 	.db #0x44	; 68	'D'
      000211 59                     904 	.db #0x59	; 89	'Y'
      000212 0D                     905 	.db #0x0d	; 13
      000213 0A                     906 	.db #0x0a	; 10
                                    907 	.area CSEG    (CODE)
                                    908 	.area XINIT   (CODE)
