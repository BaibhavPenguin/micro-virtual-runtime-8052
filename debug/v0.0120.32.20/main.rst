      ...
      000149 90 01 EF         [24]  692 	mov	dptr,#_boot_message
      ...
      000169 90 02 25         [24]  724 	mov	dptr,#_ready_msg
      ...
      00017D                        745 _clear_terminal:
                                    746 ;	src/main.c:97: uart_send(0x1B);uart_send(0x5B);(0x48); //ANSI Home Cursor
      ...
      000186 12 01 30         [24]  750 	lcall	_uart_send
                                    751 ;	src/main.c:98: uart_send(0x1B);uart_send(0x5B);uart_send(0x32);uart_send(0x4A); //Clear Sequence ANSI
      000189 75 82 1B         [24]  752 	mov	dpl, #0x1b
      00018C 12 01 30         [24]  753 	lcall	_uart_send
      00018F 75 82 5B         [24]  754 	mov	dpl, #0x5b
      000192 12 01 30         [24]  755 	lcall	_uart_send
      000195 75 82 32         [24]  756 	mov	dpl, #0x32
      000198 12 01 30         [24]  757 	lcall	_uart_send
      00019B 75 82 4A         [24]  758 	mov	dpl, #0x4a
                                    759 ;	src/main.c:99: }
      00019E 02 01 30         [24]  760 	ljmp	_uart_send
                                    761 ;------------------------------------------------------------
                                    762 ;Allocation info for local variables in function 'Serial_ISR'
                                    763 ;------------------------------------------------------------
                                    764 ;	src/main.c:103: void Serial_ISR(void) __interrupt(4)
                                    765 ;	-----------------------------------------
                                    766 ;	 function Serial_ISR
                                    767 ;	-----------------------------------------
      0001A1                        768 _Serial_ISR:
      0001A1 C0 E0            [24]  769 	push	acc
      0001A3 C0 82            [24]  770 	push	dpl
      0001A5 C0 83            [24]  771 	push	dph
      0001A7 C0 01            [24]  772 	push	ar1
      0001A9 C0 D0            [24]  773 	push	psw
      0001AB 75 D0 00         [24]  774 	mov	psw,#0x00
                                    775 ;	src/main.c:105: if(RI){
      0001AE 30 98 11         [24]  776 	jnb	_RI,00103$
                                    777 ;	src/main.c:106: *wr_pointer = SBUF;
      0001B1 90 00 33         [24]  778 	mov	dptr,#_wr_pointer
      0001B4 E0               [24]  779 	movx	a,@dptr
      0001B5 F9               [12]  780 	mov	r1,a
      0001B6 A7 99            [24]  781 	mov	@r1,_SBUF
                                    782 ;	src/main.c:107: is_recieved = 1;
                                    783 ;	assignBit
      0001B8 D2 00            [12]  784 	setb	_is_recieved
                                    785 ;	src/main.c:108: wr_pointer++;
      0001BA 90 00 33         [24]  786 	mov	dptr,#_wr_pointer
      0001BD E9               [12]  787 	mov	a,r1
      0001BE 04               [12]  788 	inc	a
      0001BF F0               [24]  789 	movx	@dptr,a
                                    790 ;	src/main.c:109: RI = 0;
                                    791 ;	assignBit
      0001C0 C2 98            [12]  792 	clr	_RI
      0001C2                        793 00103$:
                                    794 ;	src/main.c:111: }
      0001C2 D0 D0            [24]  795 	pop	psw
      0001C4 D0 01            [24]  796 	pop	ar1
      0001C6 D0 83            [24]  797 	pop	dph
      0001C8 D0 82            [24]  798 	pop	dpl
      0001CA D0 E0            [24]  799 	pop	acc
      0001CC 32               [24]  800 	reti
                                    801 ;	eliminated unneeded push/pop ar0
                                    802 ;	eliminated unneeded push/pop b
                                    803 ;------------------------------------------------------------
                                    804 ;Allocation info for local variables in function 'Timer2_ISR'
                                    805 ;------------------------------------------------------------
                                    806 ;	src/main.c:114: void Timer2_ISR(void) __interrupt(5)
                                    807 ;	-----------------------------------------
                                    808 ;	 function Timer2_ISR
                                    809 ;	-----------------------------------------
      0001CD                        810 _Timer2_ISR:
      0001CD C0 E0            [24]  811 	push	acc
                                    812 ;	src/main.c:116: system_tick++;
      0001CF E5 34            [12]  813 	mov	a,_system_tick
      0001D1 04               [12]  814 	inc	a
      0001D2 F5 34            [12]  815 	mov	_system_tick,a
                                    816 ;	src/main.c:117: }
      0001D4 D0 E0            [24]  817 	pop	acc
      0001D6 32               [24]  818 	reti
                                    819 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    820 ;	eliminated unneeded push/pop not_psw
                                    821 ;	eliminated unneeded push/pop dpl
                                    822 ;	eliminated unneeded push/pop dph
                                    823 ;	eliminated unneeded push/pop b
                                    824 ;------------------------------------------------------------
                                    825 ;Allocation info for local variables in function 'main'
                                    826 ;------------------------------------------------------------
                                    827 ;	src/main.c:120: void main(void){
                                    828 ;	-----------------------------------------
                                    829 ;	 function main
                                    830 ;	-----------------------------------------
      0001D7                        831 _main:
                                    832 ;	src/main.c:121: SP = hw_stack; 		//initiaslze Stack Pointer;
      0001D7 75 81 60         [24]  833 	mov	_SP,#0x60
                                    834 ;	src/main.c:122: init_sys();
      0001DA 12 01 04         [24]  835 	lcall	_init_sys
                                    836 ;	src/main.c:123: init_serial();
      0001DD 12 01 1F         [24]  837 	lcall	_init_serial
                                    838 ;	src/main.c:127: clear_terminal();
      0001E0 12 01 7D         [24]  839 	lcall	_clear_terminal
                                    840 ;	src/main.c:128: print_boot_message();
      0001E3 12 01 3D         [24]  841 	lcall	_print_boot_message
                                    842 ;	src/main.c:129: print_ready_message();
      0001E6 12 01 5D         [24]  843 	lcall	_print_ready_message
                                    844 ;	src/main.c:131: while(1);
      0001E9                        845 00102$:
                                    846 ;	src/main.c:132: }
      0001E9 80 FE            [24]  847 	sjmp	00102$
                                    848 	.area CSEG    (CODE)
                                    849 	.area CONST   (CODE)
                                    850 	.area CONST   (CODE)
      0001EF                        851 _boot_message:
      0001EF 4D                     852 	.db #0x4d	; 77	'M'
      0001F0 69                     853 	.db #0x69	; 105	'i'
      0001F1 63                     854 	.db #0x63	; 99	'c'
      0001F2 72                     855 	.db #0x72	; 114	'r'
      0001F3 6F                     856 	.db #0x6f	; 111	'o'
      0001F4 20                     857 	.db #0x20	; 32
      0001F5 56                     858 	.db #0x56	; 86	'V'
      0001F6 69                     859 	.db #0x69	; 105	'i'
      0001F7 72                     860 	.db #0x72	; 114	'r'
      0001F8 74                     861 	.db #0x74	; 116	't'
      0001F9 75                     862 	.db #0x75	; 117	'u'
      0001FA 61                     863 	.db #0x61	; 97	'a'
      0001FB 6C                     864 	.db #0x6c	; 108	'l'
      0001FC 2D                     865 	.db #0x2d	; 45
      0001FD 52                     866 	.db #0x52	; 82	'R'
      0001FE 20                     867 	.db #0x20	; 32
      0001FF 43                     868 	.db #0x43	; 67	'C'
      000200 6F                     869 	.db #0x6f	; 111	'o'
      000201 70                     870 	.db #0x70	; 112	'p'
      000202 79                     871 	.db #0x79	; 121	'y'
      000203 72                     872 	.db #0x72	; 114	'r'
      000204 69                     873 	.db #0x69	; 105	'i'
      000205 67                     874 	.db #0x67	; 103	'g'
      000206 68                     875 	.db #0x68	; 104	'h'
      000207 74                     876 	.db #0x74	; 116	't'
      000208 20                     877 	.db #0x20	; 32
      000209 32                     878 	.db #0x32	; 50	'2'
      00020A 30                     879 	.db #0x30	; 48	'0'
      00020B 32                     880 	.db #0x32	; 50	'2'
      00020C 36                     881 	.db #0x36	; 54	'6'
      00020D 20                     882 	.db #0x20	; 32
      00020E 42                     883 	.db #0x42	; 66	'B'
      00020F 61                     884 	.db #0x61	; 97	'a'
      000210 69                     885 	.db #0x69	; 105	'i'
      000211 62                     886 	.db #0x62	; 98	'b'
      000212 68                     887 	.db #0x68	; 104	'h'
      000213 61                     888 	.db #0x61	; 97	'a'
      000214 76                     889 	.db #0x76	; 118	'v'
      000215 20                     890 	.db #0x20	; 32
      000216 42                     891 	.db #0x42	; 66	'B'
      000217 68                     892 	.db #0x68	; 104	'h'
      000218 61                     893 	.db #0x61	; 97	'a'
      000219 74                     894 	.db #0x74	; 116	't'
      00021A 74                     895 	.db #0x74	; 116	't'
      00021B 61                     896 	.db #0x61	; 97	'a'
      00021C 63                     897 	.db #0x63	; 99	'c'
      00021D 68                     898 	.db #0x68	; 104	'h'
      00021E 72                     899 	.db #0x72	; 114	'r'
      00021F 79                     900 	.db #0x79	; 121	'y'
      000220 61                     901 	.db #0x61	; 97	'a'
      000221 0D                     902 	.db #0x0d	; 13
      000222 0A                     903 	.db #0x0a	; 10
      000223 00                     904 	.db 0x00
      000224 00                     905 	.db 0x00
                                    906 	.area CSEG    (CODE)
                                    907 	.area CONST   (CODE)
      000225                        908 _ready_msg:
      000225 52                     909 	.db #0x52	; 82	'R'
      000226 45                     910 	.db #0x45	; 69	'E'
      000227 41                     911 	.db #0x41	; 65	'A'
      000228 44                     912 	.db #0x44	; 68	'D'
      000229 59                     913 	.db #0x59	; 89	'Y'
      00022A 0D                     914 	.db #0x0d	; 13
      00022B 0A                     915 	.db #0x0a	; 10
                                    916 	.area CSEG    (CODE)
                                    917 	.area XINIT   (CODE)
