...
;	-----------------------------------------
_clear_terminal:
;	src/main.c:97: uart_send(0x1B);uart_send(0x5B);(0x48); //ANSI Home Cursor
	mov	dpl, #0x1b
	lcall	_uart_send
	mov	dpl, #0x5b
	lcall	_uart_send
;	src/main.c:98: uart_send(0x1B);uart_send(0x5B);uart_send(0x32);uart_send(0x4A); //Clear Sequence ANSI
	mov	dpl, #0x1b
	lcall	_uart_send
	mov	dpl, #0x5b
	lcall	_uart_send
