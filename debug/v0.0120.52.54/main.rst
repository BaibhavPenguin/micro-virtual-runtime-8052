      ...
      00001C                        409 	.ds	7
      000023 02 01 96         [24]  410 	ljmp	_Serial_ISR
      000026                        411 	.ds	5
      00002B 02 01 B4         [24]  412 	ljmp	_Timer2_ISR
      ...
      000071 02 01 BE         [24]  520 	ljmp	_main
      ...
      000134 22               [24]  626 	ret
                                    ...
                                    633 ;	-----------------------------------------
      000135                        634 _echo:
                                    635 ;	src/main.c:49: rd_pointer = &prog_buffer[0];
      000135 75 32 40         [24]  636 	mov	_rd_pointer,#_prog_buffer
                                    637 ;	src/main.c:50: while(!is_recieved);
      000138                        638 00101$:
      000138 30 00 FD         [24]  639 	jnb	_is_recieved,00101$
                                    640 ;	src/main.c:51: uart_send(*rd_pointer);
      00013B A9 32            [24]  641 	mov	r1,_rd_pointer
      00013D 87 82            [24]  642 	mov	dpl,@r1
      00013F 12 01 2C         [24]  643 	lcall	_uart_send
                                    644 ;	src/main.c:52: rd_pointer++;
      000142 05 32            [12]  645 	inc	_rd_pointer
                                    646 ;	src/main.c:53: is_recieved = 0;
                                    647 ;	assignBit
      000144 C2 00            [12]  648 	clr	_is_recieved
                                    649 ;	src/main.c:55: }
      000146 22               [24]  650 	ret
                                    651 ;------------------------------------------------------------
                                    652 ;Allocation info for local variables in function 'delay_ms_500'
                                    653 ;------------------------------------------------------------
                                    654 ;	src/main.c:61: void delay_ms_500(void){
                                    655 ;	-----------------------------------------
                                    656 ;	 function delay_ms_500
                                    657 ;	-----------------------------------------
      000147                        658 _delay_ms_500:
                                    659 ;	src/main.c:64: }
      000147 22               [24]  660 	ret
                                    661 ;------------------------------------------------------------
                                    662 ;Allocation info for local variables in function 'ascii_to_hex'
                                    663 ;------------------------------------------------------------
                                    664 ;	src/main.c:69: void ascii_to_hex(void){
                                    665 ;	-----------------------------------------
                                    666 ;	 function ascii_to_hex
                                    667 ;	-----------------------------------------
      000148                        668 _ascii_to_hex:
                                    669 ;	src/main.c:72: }
      000148 22               [24]  670 	ret
                                    671 ;------------------------------------------------------------
                                    672 ;Allocation info for local variables in function 'hex_to_ascii'
                                    673 ;------------------------------------------------------------
                                    674 ;	src/main.c:78: void hex_to_ascii(void){
                                    675 ;	-----------------------------------------
                                    676 ;	 function hex_to_ascii
                                    677 ;	-----------------------------------------
      000149                        678 _hex_to_ascii:
                                    679 ;	src/main.c:81: }
      000149 22               [24]  680 	ret
                                    681 ;------------------------------------------------------------
                                    682 ;Allocation info for local variables in function 'print_boot_message'
                                    683 ;------------------------------------------------------------
                                    684 ;	src/main.c:86: void print_boot_message(void){
                                    685 ;	-----------------------------------------
                                    686 ;	 function print_boot_message
                                    687 ;	-----------------------------------------
      00014A                        688 _print_boot_message:
                                    689 ;	src/main.c:87: temp0 = 0;
      00014A 75 38 00         [24]  690 	mov	_temp0,#0x00
                                    691 ;	src/main.c:88: while(temp0 != len_boot_message){
      00014D                        692 00101$:
      00014D 74 36            [12]  693 	mov	a,#0x36
      00014F B5 38 02         [24]  694 	cjne	a,_temp0,00118$
      000152 80 12            [24]  695 	sjmp	00103$
      000154                        696 00118$:
                                    697 ;	src/main.c:89: uart_send(boot_message[temp0]);
      000154 E5 38            [12]  698 	mov	a,_temp0
      000156 90 01 D9         [24]  699 	mov	dptr,#_boot_message
      000159 93               [24]  700 	movc	a,@a+dptr
      00015A F5 82            [12]  701 	mov	dpl,a
      00015C 12 01 2C         [24]  702 	lcall	_uart_send
                                    703 ;	src/main.c:90: temp0++;
      00015F E5 38            [12]  704 	mov	a,_temp0
      000161 04               [12]  705 	inc	a
      000162 F5 38            [12]  706 	mov	_temp0,a
      000164 80 E7            [24]  707 	sjmp	00101$
      000166                        708 00103$:
                                    709 ;	src/main.c:92: temp0 = 0;
      000166 75 38 00         [24]  710 	mov	_temp0,#0x00
                                    711 ;	src/main.c:93: }
      000169 22               [24]  712 	ret
                                    713 ;------------------------------------------------------------
                                    714 ;Allocation info for local variables in function 'print_ready_message'
                                    715 ;------------------------------------------------------------
                                    716 ;	src/main.c:95: void print_ready_message(void){
                                    717 ;	-----------------------------------------
                                    718 ;	 function print_ready_message
                                    719 ;	-----------------------------------------
      00016A                        720 _print_ready_message:
                                    721 ;	src/main.c:96: temp0 = 0;
      00016A 75 38 00         [24]  722 	mov	_temp0,#0x00
                                    723 ;	src/main.c:97: while(temp0 != len_ready_message){
      00016D                        724 00101$:
      00016D 74 07            [12]  725 	mov	a,#0x07
      00016F B5 38 02         [24]  726 	cjne	a,_temp0,00118$
      000172 80 12            [24]  727 	sjmp	00103$
      000174                        728 00118$:
                                    729 ;	src/main.c:98: uart_send(ready_msg[temp0]);
      000174 E5 38            [12]  730 	mov	a,_temp0
      000176 90 02 0F         [24]  731 	mov	dptr,#_ready_msg
      000179 93               [24]  732 	movc	a,@a+dptr
      00017A F5 82            [12]  733 	mov	dpl,a
      00017C 12 01 2C         [24]  734 	lcall	_uart_send
                                    735 ;	src/main.c:99: temp0++;
      00017F E5 38            [12]  736 	mov	a,_temp0
      000181 04               [12]  737 	inc	a
      000182 F5 38            [12]  738 	mov	_temp0,a
      000184 80 E7            [24]  739 	sjmp	00101$
      000186                        740 00103$:
                                    741 ;	src/main.c:101: temp0 = 0;
      000186 75 38 00         [24]  742 	mov	_temp0,#0x00
                                    743 ;	src/main.c:102: }
      000189 22               [24]  744 	ret
                                    745 ;------------------------------------------------------------
                                    746 ;Allocation info for local variables in function 'clear_terminal'
                                    747 ;------------------------------------------------------------
                                    748 ;	src/main.c:104: void clear_terminal(void){
                                    749 ;	-----------------------------------------
                                    750 ;	 function clear_terminal
                                    751 ;	-----------------------------------------
      00018A                        752 _clear_terminal:
                                    753 ;	src/main.c:107: uart_send(0x1B);uart_send(0x63); //Full Reset Terminal
      00018A 75 82 1B         [24]  754 	mov	dpl, #0x1b
      00018D 12 01 2C         [24]  755 	lcall	_uart_send
      000190 75 82 63         [24]  756 	mov	dpl, #0x63
                                    757 ;	src/main.c:108: }
      000193 02 01 2C         [24]  758 	ljmp	_uart_send
                                    759 ;------------------------------------------------------------
                                    760 ;Allocation info for local variables in function 'Serial_ISR'
                                    761 ;------------------------------------------------------------
                                    762 ;	src/main.c:112: void Serial_ISR(void) __interrupt(4)
                                    763 ;	-----------------------------------------
                                    764 ;	 function Serial_ISR
                                    765 ;	-----------------------------------------
      000196                        766 _Serial_ISR:
      000196 C0 E0            [24]  767 	push	acc
      000198 C0 00            [24]  768 	push	ar0
      00019A C0 D0            [24]  769 	push	psw
      00019C 75 D0 00         [24]  770 	mov	psw,#0x00
                                    771 ;	src/main.c:114: if(RI){
      00019F 30 98 0B         [24]  772 	jnb	_RI,00103$
                                    773 ;	src/main.c:115: *wr_pointer = SBUF;
      0001A2 E5 33            [12]  774 	mov	a,_wr_pointer
      0001A4 F8               [12]  775 	mov	r0,a
      0001A5 A6 99            [24]  776 	mov	@r0,_SBUF
                                    777 ;	src/main.c:116: is_recieved = 1;
                                    778 ;	assignBit
      0001A7 D2 00            [12]  779 	setb	_is_recieved
                                    780 ;	src/main.c:117: wr_pointer++;
      0001A9 05 33            [12]  781 	inc	_wr_pointer
                                    782 ;	src/main.c:118: RI = 0;
                                    783 ;	assignBit
      0001AB C2 98            [12]  784 	clr	_RI
      0001AD                        785 00103$:
                                    786 ;	src/main.c:120: }
      0001AD D0 D0            [24]  787 	pop	psw
      0001AF D0 00            [24]  788 	pop	ar0
      0001B1 D0 E0            [24]  789 	pop	acc
      0001B3 32               [24]  790 	reti
                                    791 ;	eliminated unneeded push/pop ar1
                                    792 ;	eliminated unneeded push/pop dpl
                                    793 ;	eliminated unneeded push/pop dph
                                    794 ;	eliminated unneeded push/pop b
                                    795 ;------------------------------------------------------------
                                    796 ;Allocation info for local variables in function 'Timer2_ISR'
                                    797 ;------------------------------------------------------------
                                    798 ;	src/main.c:123: void Timer2_ISR(void) __interrupt(5)
                                    799 ;	-----------------------------------------
                                    800 ;	 function Timer2_ISR
                                    801 ;	-----------------------------------------
      0001B4                        802 _Timer2_ISR:
      0001B4 C0 E0            [24]  803 	push	acc
                                    804 ;	src/main.c:125: system_tick++;
      0001B6 E5 34            [12]  805 	mov	a,_system_tick
      0001B8 04               [12]  806 	inc	a
      0001B9 F5 34            [12]  807 	mov	_system_tick,a
                                    808 ;	src/main.c:126: }
      0001BB D0 E0            [24]  809 	pop	acc
      0001BD 32               [24]  810 	reti
                                    811 ;	eliminated unneeded mov psw,# (no regs used in bank)
                                    812 ;	eliminated unneeded push/pop not_psw
                                    ...
                                    818 ;------------------------------------------------------------
                                    819 ;	src/main.c:129: void main(void){
                                    820 ;	-----------------------------------------
                                    821 ;	 function main
                                    822 ;	-----------------------------------------
      0001BE                        823 _main:
                                    824 ;	src/main.c:130: SP = hw_stack; 		//initiaslze Stack Pointer;
      0001BE 75 81 60         [24]  825 	mov	_SP,#0x60
                                    826 ;	src/main.c:131: init_sys();
      0001C1 12 00 FA         [24]  827 	lcall	_init_sys
                                    828 ;	src/main.c:132: init_serial();
      0001C4 12 01 1B         [24]  829 	lcall	_init_serial
                                    830 ;	src/main.c:136: clear_terminal();
      0001C7 12 01 8A         [24]  831 	lcall	_clear_terminal
                                    832 ;	src/main.c:137: print_boot_message();
      0001CA 12 01 4A         [24]  833 	lcall	_print_boot_message
                                    834 ;	src/main.c:138: print_ready_message();
      0001CD 12 01 6A         [24]  835 	lcall	_print_ready_message
                                    836 ;	src/main.c:140: while(1){
      0001D0                        837 00102$:
                                    838 ;	src/main.c:141: echo();
      0001D0 12 01 35         [24]  839 	lcall	_echo
                                    840 ;	src/main.c:143: }
      0001D3 80 FB            [24]  841 	sjmp	00102$
                                    842 	.area CSEG    (CODE)
                                    843 	.area CONST   (CODE)
                                    844 	.area CONST   (CODE)
      0001D9                        845 _boot_message:
      0001D9 4D                     846 	.db #0x4d	; 77	'M'
      0001DA 69                     847 	.db #0x69	; 105	'i'
      0001DB 63                     848 	.db #0x63	; 99	'c'
      0001DC 72                     849 	.db #0x72	; 114	'r'
      0001DD 6F                     850 	.db #0x6f	; 111	'o'
      0001DE 20                     851 	.db #0x20	; 32
      0001DF 56                     852 	.db #0x56	; 86	'V'
      0001E0 69                     853 	.db #0x69	; 105	'i'
      0001E1 72                     854 	.db #0x72	; 114	'r'
      0001E2 74                     855 	.db #0x74	; 116	't'
      0001E3 75                     856 	.db #0x75	; 117	'u'
      0001E4 61                     857 	.db #0x61	; 97	'a'
      0001E5 6C                     858 	.db #0x6c	; 108	'l'
      0001E6 2D                     859 	.db #0x2d	; 45
      0001E7 52                     860 	.db #0x52	; 82	'R'
      0001E8 20                     861 	.db #0x20	; 32
      0001E9 43                     862 	.db #0x43	; 67	'C'
      0001EA 6F                     863 	.db #0x6f	; 111	'o'
      0001EB 70                     864 	.db #0x70	; 112	'p'
      0001EC 79                     865 	.db #0x79	; 121	'y'
      0001ED 72                     866 	.db #0x72	; 114	'r'
      0001EE 69                     867 	.db #0x69	; 105	'i'
      0001EF 67                     868 	.db #0x67	; 103	'g'
      0001F0 68                     869 	.db #0x68	; 104	'h'
      0001F1 74                     870 	.db #0x74	; 116	't'
      0001F2 20                     871 	.db #0x20	; 32
      0001F3 32                     872 	.db #0x32	; 50	'2'
      0001F4 30                     873 	.db #0x30	; 48	'0'
      0001F5 32                     874 	.db #0x32	; 50	'2'
      0001F6 36                     875 	.db #0x36	; 54	'6'
      0001F7 20                     876 	.db #0x20	; 32
      0001F8 42                     877 	.db #0x42	; 66	'B'
      0001F9 61                     878 	.db #0x61	; 97	'a'
      0001FA 69                     879 	.db #0x69	; 105	'i'
      0001FB 62                     880 	.db #0x62	; 98	'b'
      0001FC 68                     881 	.db #0x68	; 104	'h'
      0001FD 61                     882 	.db #0x61	; 97	'a'
      0001FE 76                     883 	.db #0x76	; 118	'v'
      0001FF 20                     884 	.db #0x20	; 32
      000200 42                     885 	.db #0x42	; 66	'B'
      000201 68                     886 	.db #0x68	; 104	'h'
      000202 61                     887 	.db #0x61	; 97	'a'
      000203 74                     888 	.db #0x74	; 116	't'
      000204 74                     889 	.db #0x74	; 116	't'
      000205 61                     890 	.db #0x61	; 97	'a'
      000206 63                     891 	.db #0x63	; 99	'c'
      000207 68                     892 	.db #0x68	; 104	'h'
      000208 72                     893 	.db #0x72	; 114	'r'
      000209 79                     894 	.db #0x79	; 121	'y'
      00020A 61                     895 	.db #0x61	; 97	'a'
      00020B 0D                     896 	.db #0x0d	; 13
      00020C 0A                     897 	.db #0x0a	; 10
      00020D 00                     898 	.db 0x00
      00020E 00                     899 	.db 0x00
                                    900 	.area CSEG    (CODE)
                                    901 	.area CONST   (CODE)
      00020F                        902 _ready_msg:
      00020F 52                     903 	.db #0x52	; 82	'R'
      000210 45                     904 	.db #0x45	; 69	'E'
      000211 41                     905 	.db #0x41	; 65	'A'
      000212 44                     906 	.db #0x44	; 68	'D'
      000213 59                     907 	.db #0x59	; 89	'Y'
      000214 0D                     908 	.db #0x0d	; 13
      000215 0A                     909 	.db #0x0a	; 10
                                    910 	.area CSEG    (CODE)
                                    911 	.area XINIT   (CODE)
