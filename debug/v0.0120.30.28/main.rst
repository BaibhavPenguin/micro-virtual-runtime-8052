      ...
      00017D                        745 _clear_terminal:
                                    746 ;	src/main.c:97: uart_send(0x1B);uart_send(0x5B);uart_send(0x32);uart_send(0x4A); //Clear Sequence ANSI
      ...
      000192 12 01 30         [24]  754 	lcall	_uart_send
                                    755 ;	src/main.c:98: uart_send(0x1B);uart_send(0x5B);(0x48); //ANSI Home Cursor
      000195 75 82 1B         [24]  756 	mov	dpl, #0x1b
      000198 12 01 30         [24]  757 	lcall	_uart_send
      00019B 75 82 5B         [24]  758 	mov	dpl, #0x5b
                                    759 ;	src/main.c:99: }
